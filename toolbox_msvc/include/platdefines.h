...
/*
    (c) Copyright 1990-2025 by National Instruments Corp.
    All rights reserved.
...
#define kVxWorks 29 // OBSOLETE
#define kPalmOS 30 // OBSOLETE
#define kLinux64 31 // OBSOLETE: DO NOT USE: UNUSED AND UNDEFINED: PRESERVED FOR DOCUMENTARY PURPOSES ONLY
#define kVdk 32 // OBSOLETE
#define kRtx 33 // OBSOLETE
...
#define kMotorolaCC 22 // OBSOLETE
...
#define kX86 2
#define kSparc 3 // OBSOLETE
#define kPPC 4 // OBSOLETE
#define kPARISC 5 // OBSOLETE
#define kMIPS 6 // OBSOLETE
#define kDECAlpha 7 // OBSOLETE
#define kPIC 8 // OBSOLETE
#define kARM 9
#define kX64 10
#define kARM64 11
...
#define NI_BIG_ENDIAN 0
#else
#error "unknown macOS ProcessorType"  // 68K is no longer a reasonable fallback!
#endif
...
#define MacARM64 (OpSystem == kMacOSX && ProcessorType == kARM64)
#define MacCocoa (MacX64 || MacARM64)
#define XWindows (WindowSystem == kXWindows)
#define Linux (OpSystem == kLinux)
#define NoWS (WindowSystem == kNoWS)

// Obsolete defines left for clients that still use them
#define VxWorks 0 // OBSOLETE
#define PharLap 0 // OBSOLETE
...
#define kVxWorksThreads 4 // OBSOLETE
#define kVdkThreads 6 // OBSOLETE
#define kRtxThreads 7 // OBSOLETE
...
#define IsOpSystem64Bit ((ProcessorType == kX64) || (ProcessorType == kARM64))
...
#if (ProcessorType == kX86) || (ProcessorType == kX64) || (ProcessorType == kARM64)
#define UseGetSetIntMacros 1
#else
#define UseGetSetIntMacros 0
#endif

// If distinguishing C++ vs C, checking whether __cplusplus is defined works fine.
// If distinguishing specific C++ versions, use NI_CPLUSPLUS_VERSION which compensates
//   for differences in behavior between compilers.
#ifndef NI_CPLUSPLUS_VERSION
#if defined(_MSVC_LANG)
#define NI_CPLUSPLUS_VERSION _MSVC_LANG
#elif defined(__cplusplus)
#define NI_CPLUSPLUS_VERSION __cplusplus
#else
#define NI_CPLUSPLUS_VERSION 0
#endif
#endif

#define CompilerSupportsFullCPlusPlus11 (NI_CPLUSPLUS_VERSION >= 201103L && !(Compiler == kGCC && __GNUC__ <= 4))
// ^gcc-4.7-oe (used for Linux ARM) does mostly support c++11 with -std=c++11 option;
// it defines the __cplusplus macro and does support our new recent C++ usage in LV 2022
// which is not guarded with this macro (auto, class enums, etc.), but it does not support
// the stl emplace methods used by GSet/GMap.
#define CompilerSupportsCPlusPlus14 (NI_CPLUSPLUS_VERSION >= 201402L)
#define CompilerSupportsCPlusPlus17 (NI_CPLUSPLUS_VERSION >= 201703L)

...
//============================================================================
#if defined(_MSC_VER) && !defined(_CVI_) && !defined(__BORLANDC__) && !defined _M_X64
    #pragma comment(linker, "/INCLUDE:_nivision_startup_shutdown")
    #pragma comment(linker, "/DEFAULTLIB:nivision.lib")
#elif defined(_MSC_VER) && !defined(_CVI_) && !defined(__BORLANDC__) && defined _M_X64
    #pragma comment(linker, "/INCLUDE:nivision_startup_shutdown")
    #pragma comment(linker, "/DEFAULTLIB:nivision.lib")
#endif
...
#define ERR_UNREGISTERED                                             -1074396157 // Unlicensed copy of NI Vision Development Module or NI Vision Runtime.
...
#define ERR_ZERO_BIT_DEPTH_FOR_16BIT_SGL_IMAGE                       -1074395452 // The bit depth in the given 16-bit/SGL image is zero. This function requires a non-zero bit depth to be set.
...
#define ERR_DIRECTX_UNKNOWN_COMPRESSION_FILTER                       -1074396006 // Unknown codec.
...
#define ERR_INVALID_FRAMES_PER_SECOND                                -1074395982 // The frames per second in an AVI must be greater than zero and less than 100,000.
...
#define ERR_AVI_OPEN                                                 -1074395970 // Error opening AVI file. An appropriate codec to process this file might not have been found. Install the codec that was used to create this AVI.
#define ERR_AVI_CREATE                                               -1074395969 // Error creating AVI file.
#define ERR_AVI_WRITE                                                -1074395968 // Error writing AVI frame
#define ERR_AVI_READ                                                 -1074395967 // Error reading AVI frame
#define ERR_AVI_IMAGE_CONVERSION                                     -1074395966 // The image cannot be converted to a type compatible with the codec used.<LF/>You either provided a 16-bit monochrome image or 64-bit color image and the bit depth is not set, or the codec only supports grayscale images and a color image was used.
#define ERR_AVI_MAX_SIZE_REACHED                                     -1074395965 // The AVI file has reached its maximum size of 2 Gigabytes.
#define ERR_AVI_INVALID_CODEC_SOURCE                                 -1074395964 // Invalid codec source.
#define ERR_AVI_EXTENSION_REQUIRED                                   -1074395963 // The file name must have the .avi extension.
#define ERR_EMPTY_CODEC                                              -1074395962 // The codec name passed is empty. Specify a codec name.
...
#define ERR_INVALID_OBJECT_TRACKING_FILE                             -1074395925 // The input file is not a valid object tracking file.
#define ERR_PYRAMID_LEVEL_NOT_VALID                                  -1074395924 // Invalid pyramid level for pyramid Pattern Matching
#define ERR_INVALID_ANGLE_RANGE                                      -1074395923 // Invalid angle range value for pyramid Pattern Matching
#define ERR_INVALID_LEARN_ANGLE_RANGE                                -1074395922 // Invalid learn angle range for pyramid pattern matching
#define ERR_OPENING_NEWER_OBJECT_TRACKING_REFNUM                     -1074395921 // The object tracking file that you tried to open was created with a newer version of NI Vision. Upgrade to the latest version of NI Vision to read this file.
#define ERR_NUMBER_CLASS                                             -1074395920 // Invalid number of classes.
#define ERR_INVALID_THRESHOLD_TYPE                                   -1074395919 // Supplied Threshold Type is Invalid
#define ERR_MULTIPLE_LINE_DETECTION_NOT_ENABLED                      -1074395918 // Multiple line text is not supported without enabling Text Location Property
#define ERR_OCR_INVALID_LINE_SEPARATOR                               -1074395917 // Supplied line separator is not supported
#define ERR_INVALID_OBJECT_POSITION                                  -1074395916 // Invalid object position provided. The object should be in the image frame.
#define ERR_UNEQUAL_IMAGE_SIZE_FOR_OBJECT_ADDITION                   -1074395915 // Unequal image size passed for object addition. Image sizes should be the same for all added objects.
#define ERR_INVALID_INITIAL_ANGLE                                    -1074395914 // Invalid intial angle specified. It should be in [0, 180] range.
#define ERR_UNINITIATED_SHAPE_ADAPTED_MEANSHIFT                      -1074395913 // Shape Adapted MeanShift is not initialized. Initialize Shape Adapted MeanShift.
#define ERR_UNINITIATED_MEANSHIFT                                    -1074395912 // MeanShift has not been initialized. Initialize MeanShift before getting the related description.
#define ERR_INVALID_MIN_SCORE                                        -1074395911 // Invalid minimum score passed. It should be in [0, 1000] range.
#define ERR_INVALID_BOUNDINGBOX                                      -1074395910 // Invalid bounding box passed.
#define ERR_INVALID_COVARIANCEMATRIX                                 -1074395909 // Invalid covariance matrix passed.
#define ERR_BAD_GAUSSIANKERNEL                                       -1074395908 // Bad Gaussian kernel generated. Reinitialize the object.
#define ERR_OBJECT_IS_LOST                                           -1074395907 // Object to be tracked is lost. Initialize the object again.
#define ERR_INVALID_HISTOGRAMSIZE                                    -1074395906 // Invalid histogram size. Specify the same number of histogram bins for the same image type.
#define ERR_INVALID_HISTOGRAMTYPES                                   -1074395905 // Invalid histogram type. Reread the current image in the same format as the previous one.
#define ERR_OBJECT_OUTSIDE_FRAME                                     -1074395904 // Object is outside the frame. Reinitialize the object.
#define ERR_INVALID_HISTOGRAMBINS_FOR_COLOR_PROCESSING               -1074395903 // Invalid number of histogram bins for color processing. It should be in [2, 40] range.
#define ERR_SUMHIST_UNEXPECTED                                       -1074395902 // Object Histogram cannot describe this object. Reinitialize the object.
#define ERR_INVALID_OBJECTTRACKING_REFNUM                            -1074395901 // Invalid Object Tracking Refnum passed. Initiate a proper refnum.
#define ERR_NO_SHAPEADAPTEDMEANSHIFT_INSTANCE                        -1074395900 // No Shape Adapted MeanShift Instance found. Initialize at least one instance.
#define ERR_NO_MEANSHIFT_INSTANCE                                    -1074395899 // No MeanShift Instance found. Initialize at least one instance.
#define ERR_INVALID_OBJECT_TRACKING_INSTANCE_NUMBER                  -1074395898 // Invalid object instance passed. Object instance should be given for an object to be tracked.
#define ERR_INVALID_TRACKINGMEHOD                                    -1074395897 // Invalid Tracking Method selected. It should be either MeanShift or ShapeAdapted MeanShift.
#define ERR_INVALID_BLOBTRACKING_INFO                                -1074395896 // Invalid Blob Tracking Info passed. Initiate objects to be tracked first.
#define ERR_UNINITIALIZED_OBJECTTRACKING_REFNUM                      -1074395895 // Object Tracking Refnum does not contain any objects to track. Add object instances to be tracked.
#define ERR_INVALID_INSTANCENUMBER                                   -1074395894 // Instance number to be deleted is greater than number of instances present.
#define ERR_INVALID_MAXSHAPECHANGE                                   -1074395893 // Max Shape Change Parameter is out of range. It should be in [0.0, 100.0] range.
#define ERR_INVALID_MAXROTATIONCHANGE                                -1074395892 // Max Rotation Change parameter is out of range. It should be in [0.0, 180.0] range.
#define ERR_INVALID_MAXSCALECHANGE                                   -1074395891 // Max Scale Change parameter is out of range. It should be in [0.0, 100.0] range.
#define ERR_INVALID_NUMBER_OF_HISTOGRAMBINS                          -1074395890 // Invalid number of histogram bins. Number of histogram bins should be in [2, 256] range.
#define ERR_INVALID_BLENDINGPARAMETER                                -1074395889 // Blending Parameter is out of range. It should be in [0.0, 100.0] range.
...
#define ERR_EDVR_UNSUPPORTED_ARRAY_TYPE                              -1074395874 // The requested data type for the External Data Value Reference array is not supported.
#define ERR_EDVR_INCOMPATIBLE_ARRAY_TYPE                             -1074395873 // The requested data type for the External Data Value Reference array is not compatible with the other settings.<LF/>The Optional Rectangle width in bytes must be a multiple of the EDVR data type size in bytes.<LF/>If Include Border Pixels is enabled, the source image border size bytes must be a multiple of the EDVR data type size in bytes.<LF/>If the EDVR array is 1D, the source image border size in bytes must be a multiple of the EDVR data type size in bytes and the source image line padding size in bytes must be a multiple of the EDVR data type size in bytes.<LF/>If the EDVR array is 3D, the source image pixel size in bytes must be a multiple greater than 1 of the EDVR data type size in bytes.<LF/>If the EDVR array is 1D or 2D and X Step Size is greater than 1, the source image pixel size in bytes must be equal to the EDVR data type size in bytes.
#define ERR_EDVR_INVALID_RECT_WIDTH                                  -1074395872 // The width specified by the Optional Rectangle input must be greater than 0.<LF/>If the EDVR array is one-dimensional, the width specified by the Optional Rectangle input must be equal to the X resolution of the source image.
#define ERR_EDVR_INVALID_RECT_HEIGHT                                 -1074395871 // The height specified by the Optional Rectangle input must be greater than 0.
#define ERR_EDVR_INVALID_XSTEP                                       -1074395870 // The X Step Size must be greater than 0.<LF/>The width specified by the Optional Rectangle input must be a multiple of the X Step Size.<LF/>If the Include Border Pixels input is enabled, then the source image border size must be a multiple of the X Step Size.<LF/>If the EDVR array is one-dimensional, then the source image border size must be a multiple of the X Step Size and the source image line padding size must be a multiple of the X Step Size.
#define ERR_EDVR_INVALID_YSTEP                                       -1074395869 // The Y Step Size must be greater than 0.<LF/>The height specified by the Optional Rectangle input must be a multiple of the Y Step Size.<LF/>If the Include Border Pixels input is enabled, then the source image border size must be a multiple of the Y Step Size.<LF/>If the EDVR array is one-dimensional, then the Y Step Size must be equal to 1.
#define ERR_INVALID_NUM_REQUIRED_BARCODES                            -1074395868 // The number of required barcodes specified should be &quot;1&quot; when Skip Location Search option is enabled
#define ERR_INVALID_SIZE_FOR_DMA_FIFO_TRANSFER                       -1074395867 // The resulting image size is 0.  If the Image Size control specifies a Width and Height of 0, then the Image In must contain a non-zero-sized image.  Otherwise, the Image Size control must specify a non-zero Width and Height.
#define ERR_MORE_THAN_1_MATCHING_CTL                                 -1074395866 // More than 1 control on the FPGA front panel matches the requested type.  Specify the control name to select the desired instance.
#define ERR_MORE_THAN_1_MATCHING_DMA_FIFO                            -1074395865 // More than 1 DMA FIFO matches the requested type.  Specify the DMA FIFO name to select the desired DMA FIFO.
#define ERR_FIFO_DEPTH_IS_0                                          -1074395864 // The DMA FIFO Depth in Images cannot be 0.
#define ERR_NO_MATCHING_CTL                                          -1074395863 // No control on the FPGA front panel matches the requested type.  Set the Control Name to &quot;Skip&quot; to skip over this step and ignore this error.
#define ERR_NO_MATCHING_DMA_FIFO                                     -1074395862 // No DMA FIFO matches the requested type.
#define ERR_INVALID_MAX_PIXELS_PER_WRITE_OR_READ                     -1074395861 // The value given for Maximum Pixels per Write or Maximum Pixels per Read is not valid.
#define ERR_INVALID_EDVR_DIMENSION                                   -1074395860 // The number of array dimensions specified by the External Data Value Reference must be equal to 1.
#define ERR_INVALID_IMAGE_OFFSET                                     -1074395859 // The X image offset is greater than or equal to the image width, or the Y image offset is greater than or equal to the image height.
#define ERR_MISMATCHED_ELEMENT_SIZE                                  -1074395858 // The image pixel size does not match the External Data Value Reference element size.
#define ERR_DISPLAY_COMMUNICATION                                    -1074395841 // Unable to contact Demon/server or Bad Command
...
#define ERR_INVALID_SAUVOLA_DEVIATION_RANGE                          -1074395761 // The deviation range for Sauvola local threshold must be greater than 0
...
#define ERR_INVALID_EDGE_THRESHOLD                                   -1074395601 // Invalid edge threshold. Valid values range from 1 to 65535.
...
#define ERR_NO_IMAGE_LESS_THAN_TWO                                   -1074395548 // Number of Images must be greater than 1
#define ERR_NO_IMAGE_LESS_THAN_THREE                                 -1074395547 // Number of Images must be greater than 2
#define ERR_FLAT_FIELD_INFO_NOT_AVAILABLE                            -1074395546 // Flat field correction vision info is not available.
#define ERR_FLATFIELD_AND_DARK_FIELD_NOT_AVAILABLE                   -1074395545 // Flat field and Dark field image are not suppiled. You need to supply atleast one of them to perform flat field correction
#define ERR_INVALID_PRESET_OPTION                                    -1074395544 // Unsupported preset match option is supplied.
#define ERR_INVALID_PRESET_FUNCTION                                  -1074395543 // Unsupported function option is supplied.
#define ERR_INVALID_ALGORITHM                                        -1074395542 // Selected Algorithm is not supported.
#define ERR_NO_LOOKUP_TABLE                                          -1074395533 // An empty Lookup Table cannot be used to convert an image using the Lookup Table method.
#define ERR_INVALID_METHOD                                           -1074395532 // The supplied method option is not supported.
#define ERR_INF_OR_NAN_PARAMETER_VALUE                               -1074395448 // Inf or NaN value supplied for parameter
#define ERR_INSUFFICIENT_COLOR_POINTS                                -1074395447 // Supplied color points are not enough to create a palette
#define ERR_COLOPOINT_PIXEL_IS_INVALID                               -1074395446 // Color Point pixel is Invalid. Pixel ranges from 0-65535 for 16bit and 0-255 for 8bit palettes
#define ERR_TOO_FEW_MATCHES                                          -1074395445 // The matches are too few to perform the operation
#define ERR_GRID_SIZES_TOO_LESS                                      -1074395444 // The grid size X and grid size Y should be greater than 1
#define ERR_GRID_SIZES_TOO_LARGE                                     -1074395443 // The grid size X and grid size Y cannot be greater than the image or ROI width and height
#define ERR_SIZE_MISMATCH_FEATURES_AND_DESCRIPTORS                   -1074395442 // The feature points and descriptors of an image should be of the same size
#define ERR_MATCHING_DISTANCE_LESS_THAN_ZERO                         -1074395441 // The max Acceptable distance should be greater than zero
#define ERR_NO_DESCRIPTORS                                           -1074395440 // The descriptors should not be NULL to perform the Matching operation
#define ERR_NO_FEATURE_POINTS                                        -1074395439 // The feature points passed is NULL
#define ERR_PYRAMID_LEVEL_LESS_THAN_ONE                              -1074395438 // The pyramid level should be greater than 1 to perform the operation
#define ERR_MAX_CHAR_LENGTH_PER_LINE                                 -1074395437 // Reached maximum character length of 255 characters per line.
#define ERR_INCOMP_IMAGE_SIZE_FOR_TRACKING                           -1074395436 // Incompatible image size passed for object tracking. All images should be of equal size.
#define ERR_INVALID_MIN_OR_MAX_DEPTH_VALUE                           -1074395435 // The specified minimum or maximum depth value (or both) is not supported.
#define ERR_INVALID_POLYNOMIAL_ORDER                                 -1074395434 // The specified value of polynomial order is not supported.
#define ERR_INVALID_INTERPOLATION_SAMPLING_FREQUENCY                 -1074395433 // The specified sampling frequency value is not supported.
#define ERR_INVALID_STEREO_INVALID_MIN_DEPTH                         -1074395432 // The minimum depth value specified has to be greater than zero.
#define ERR_INVALID_STEREO_INVALID_DISPARITY_VALUE                   -1074395431 // The pixel value specified for invalid disparities is not correct.
#define ERR_INVALID_STEREO_CAMERA_TRANSLATION                        -1074395430 // The translation between the stereo cameras is zero.
#define ERR_INVALID_STEREO_CAMERA_POSITION                           -1074395429 // The specified camera position is invalid.
#define ERR_INVALID_STEREO_BLOCKMATCHING_POSTFILTER_SPECKLERANGE     -1074395428 // The value specified for the speckle range in block matching is invalid.
#define ERR_INVALID_STEREO_BLOCKMATCHING_POSTFILTER_SPECKLESIZE      -1074395427 // The size of the speckle window is invalid.
#define ERR_INVALID_STEREO_BLOCKMATCHING_POSTFILTER_TEXTURE          -1074395426 // The texture threshold specified for block matching is invalid.
#define ERR_INVALID_STEREO_BLOCKMATCHING_POSTFILTER_UNIQUENESS       -1074395425 // The specified value for uniqueness for block matching is invalid.
#define ERR_INVALID_MIN_DEPTH_VALUE                                  -1074395424 // The mininum depth value is incorrect.
#define ERR_INVALID_STEREO_Q_MATRIX                                  -1074395423 // The size of the Q matrix is not correct.
#define ERR_INVALID_STEREO_SCALING_PARAMETER                         -1074395422 // The specified value for the scaling parameter during learning stereo calibration is invalid.
...
#define ERR_INVALID_STEREO_BLOCKMATCHING_NUMDISPARITIES              -1074395418 // The specified value for number of disparities or minimum number of disparities is invalid.
...
#define ERR_WEIGHT_MAP_INVALID_IMAGE_TYPE                            -1074395219 // Weight map is of Invalid Image type. The type supported is Float (Grayscale SGL)
#define ERR_NO_MATCH_FOUND_TO_CALCULATE_DEFECT_MAP                   -1074395218 // No match has been found from Pattern Matching to Calculate Defect Map
#define ERR_INVALID_NUM_DEFECT_IMAGES_IN                             -1074395217 // The number of input defect images provided to populate the defect map are too less
#define ERR_DEFECT_MAP_INFORMATION_NOT_FOUND                         -1074395216 // The image does not contain Defect Map information.
#define ERR_OPENING_NEWER_DEFECT_MAP_DATA                            -1074395215 // The Defect Map data attached to the image you tried to open was created with a newer version of NI Vision. Upgrade to the latest version of NI Vision to read this file
...
#define ERR_ECC_CODE_NOT_SUPPORTED                                   -1074395208 // Data Matrix ECC code type is not supported by the Data Matrix grading standard.
#define ERR_INVALID_GRADING_REFLECTANCE_PARAMETER                    -1074395207 // IMAQ Vision does not support the Grading Reflectance value you supplied.
...
#define ERR_BAYER_INVALID_ALGORITHM                                  -1074395135 // The Bayer decode algorithm provided is not supported.
#define ERR_BAYER_INVALID_PATTERN                                    -1074395134 // The Bayer pattern provided is not supported.
#define ERR_BAYER_INVALID_RED_GAIN                                   -1074395133 // The red channel gain value for the Bayer decode is out of range.
#define ERR_BAYER_INVALID_GREEN_GAIN                                 -1074395132 // The green channel gain value for the Bayer decode is out of range.
#define ERR_BAYER_INVALID_BLUE_GAIN                                  -1074395131 // The blue channel gain value for the Bayer decode is out of range.
#define ERR_TARGET_NO_SUPPORT                                        -1074395130 // This IP is not supported on the current target
#define ERR_IP_VARIANT_NOT_SUPPORTED                                 -1074395129 // This variant is not supported on the current target . Please use other variant of the IP
#define ERR_INSUFFICIENT_SRC_DATA                                    -1074395128 // There is insufficient source data to perform the operation.
#define ERR_PARTIAL_IMAGE_SRC_DATA                                   -1074395127 // Source data provided is less than a full image with the specified dimensions and type.
#define ERR_INVALID_IMAGE_BYTE_OFFSET                                -1074395126 // The image byte offset is greater than or equal to the image payload size in bytes.
#define ERR_NONZERO_IMAGE_BYTE_OFFSET                                -1074395125 // A nonzero image byte offset is not supported.
#define ERR_INVALID_MIPI_CSI2_FORMAT                                 -1074395124 // The MIPI CSI-2 format provided is not supported.
#define ERR_ODD_Y_RES                                                -1074395123 // The y resolution of the image is odd but the pixel format requires an even number of lines.
#define _FIRST_ERR  ERR_SYSTEM_ERROR
#define _LAST_ERR   ERR_ODD_Y_RES
...
typedef enum LearnSetupOption_enum {
    // Old PM options
    IMAQ_LDLO_SearchStrategy            =   0,               //Specifies the aggressiveness of the search strategy available during the matching phase. Three types of search strategies are available. The default is 2. (1) Conservative-Extracts template information for Conservative matching only. (2) Balanced-Extracts template information for Balanced and Conservative matching. (3) Aggressive-Extracts template information for Aggressive, Balanced, and Conservative matching.
    IMAQ_LDLO_InitialStepSize           =   1,               //Specifies the largest number of image pixels to shift the sample across the inspection image during the initial phase of matching. The default values are 5 for the Balanced search strategy and 3 for the Conservative search strategy. If the step size is not an odd integer, the VI coerces it to the next smaller odd integer. Note:The Aggressive search strategy does not support the Initial Step Size option.
    IMAQ_LDLO_InitialSampleSize         =   2,               //Specifies the number of template pixels that you want to include in a sample for the initial phase of matching. The default is 0, which allows the algorithm to compute the Initial Sample Size. For optimal speed, the VI coerces sizes that are less than 240 to an integer multiple of 12 and coerces sizes greater than 240 to an integer multiple of 60.
    IMAQ_LDLO_InitialSampleSizeFactor   =   3,               //Specifies the size of the sample for the initial phase of rotation-invariant matching as a percent of the template size, in pixels. The default is 0, which causes the VI to use the Initial Sample Size. If you provide values for both the Initial Sample Size Factor and the Initial Sample Size, the VI uses the Initial Sample Size. For optimal speed, the VI coerces sizes that are less than 240 to an integer multiple of 12 and coerces sizes greater than 240 to an integer multiple of 60.
    IMAQ_LDLO_InitialAngularAccuracy    =   4,               //Initial Angular Accuracy sets the angle accuracy, in degrees, to use during the initial phase of matching. The default is 6 degrees. The VI coerces the angle to the largest integer smaller than it that evenly divides 360. This option is not used in conjunction with the Aggressive search strategy.
    IMAQ_LDLO_FinalSampleSize           =   5,               //Specifies the number of template pixels you want to add to the Initial Sample Size for the final phase of matching. These additional points include edge points. The default is 0, which allows the algorithm to compute the Final Sample Size. For optimal speed, the VI coerces sizes that are less than 240 to an integer multiple of 12 and coerces sizes greater than 240 to an integer multiple of 60.
    IMAQ_LDLO_FinalSampleSizeFactor     =   6,               //Specifies the size of the sample for the final phase of matching as a percent of the edge points in the template, in pixels. The default is 0, which causes the VI to use the Final Sample Size. If you provide values for both the Final Sample Size Factor and the Final Sample Size, the VI uses the Final Sample Size. For optimal speed, the VI coerces sizes that are less than 240 to an integer multiple of 12 and coerces sizes greater than 240 to an integer multiple of 60.
    IMAQ_LDLO_FinalAngularAccuracy      =   7,               //Sets the angle accuracy, in degrees, to use during the final phase of the matching. The default is 1 degree. Use subpixel accuracy to achieve angle accuracy less than the default. This value must be no greater than the value for Initial Angular Accuracy. The VI coerces the angle to the largest integer smaller than it that evenly divides 360. This option is not used in conjunction with the Aggressive search strategy.
    IMAQ_LDLO_SubpixelSampleSize        =   8,               //Specifies the number of template pixels that you want to include in a sample for the subpixel phase of matching. The default is 0, which allows the algorithm to compute the Subpixel Sample Size. For optimal speed, the VI coerces sizes that are less than 240 to an integer multiple of 12 and coerces sizes greater than 240 to an integer multiple of 60.
    IMAQ_LDLO_SubpixelSampleSizeFactor  =   9,               //Specifies the size of the sample for the subpixel phase of matching as a percent of the template size, in pixels. The default is 0, which causes the VI to use the Subpixel Sample Size. For optimal speed, the VI coerces sizes that are less than 240 to an integer multiple of 12 and coerces sizes greater than 240 to an integer multiple of 60.
	IMAQ_LDLO_MatchOffsetXPosition      =   10,              //Specifies the number of pixels the VI shifts the origin of the template from the center of the template image. The match offset is used by the IMAQ Match Pattern 4 VI to set the Position element of the resulting Matches cluster for each template match within a target image. The default value is (0, 0), which sets the center of the template image as the origin of the template.
	IMAQ_LDLO_MatchOffsetYPosition      =   11,              //Specifies the number of pixels the VI shifts the origin of the template from the center of the template image. The Match offset is used by the IMAQ Match Pattern 4 VI to set the Position element of the resulting Matches cluster for each template match within a target image. The default value is (0, 0), which sets the center of the template image as the origin of the template.
	IMAQ_LDLO_MatchOffsetAngle          =   12,              //Specifies the angle by which each match is rotated round the origin of the template. The angle offset is used by the IMAQ Match Pattern 4 VI to set the Angle element of the resulting Matches cluster for each template match within a target image. The default value is 0 which does not change the angle of the matches.
    // Pyramid Matching Options
	IMAQ_PYLO_SubpixelSampleSize        =   100,             //Specifies the number of template pixels that you want to include in a sample for the subpixel phase of matching. The default is 0, which allows the algorithm to compute the Subpixel Sample Size. For optimal speed, the VI coerces sizes that are less than 240 to an integer multiple of 12 and coerces sizes greater than 240 to an integer multiple of 60.
	IMAQ_PYLO_SubpixelSampleSizeFactor  =   101,             //Specifies the size of the sample for the subpixel phase of matching as a percent of the template size, in pixels. The default is 0, which causes the VI to use the Subpixel Sample Size. For optimal speed, the VI coerces sizes that are less than 240 to an integer multiple of 12 and coerces sizes greater than 240 to an integer multiple of 60.
	IMAQ_PYLO_MatchOffsetXPosition      =   102,             //Specifies the number of pixels the VI shifts the origin of the template from the center of the template image. The match offset is used by the IMAQ Match Pattern 4 VI to set the Position element of the resulting Matches cluster for each template match within a target image. The default value is (0, 0), which sets the center of the template image as the origin of the template.
	IMAQ_PYLO_MatchOffsetYPosition      =   103,             //Specifies the number of pixels the VI shifts the origin of the template from the center of the template image. The Match offset is used by the IMAQ Match Pattern 4 VI to set the Position element of the resulting Matches cluster for each template match within a target image. The default value is (0, 0), which sets the center of the template image as the origin of the template.
	IMAQ_PYLO_MatchOffsetAngle          =   104,             //Specifies the angle by which each match is rotated round the origin of the template. The angle offset is used by the IMAQ Match Pattern 4 VI to set the Angle element of the resulting Matches cluster for each template match within a target image. The default value is 0 which does not change the angle of the matches.
    IMAQ_PYLO_MaxPyramidLevelToStoreData=   105,             //Specifies the pyramid level up to which data is stored in a learned template when rotated templates are to be learned. The template data for pyramid levels less than this value is stripped away. A value of 0 implies that no data has been stripped, making the template the largest, while progressively higher values up to the computed Max Pyramid Level result in progressively smaller templates. The default value is 2, which means data for levels 1 and 0 is stripped. When learning a large template for a large angle range, the amount of data generated can be fairly significant and this parameter can be used to control the size. However, all the removed data needs to be re-computed by IMAQ Match Pattern 4, which increases match times. A trade-off needs to be made between a smaller template size and faster match times. Learning for Shift is not affected by this parameter.
    IMAQ_PYLO_PreProcess                =   106,             //Specifies whether to pre-process the template image and the input image while learning and matching. The default value for this option is 0 indicating no pre-processing. (0) No Processing. (1) Sobel and log transform - Template and match image are processed with sobel filter and log transform lookup table. (2) Sobel - Template and Match Image are processed with Sobel filter. (3) Non Linear Diffusion Filter - Template and Match Image Pyramids are processed with Non Linear Diffusion (Anisotropic Diffusion) filter. This option reduces noise and improves edge contrast.
    IMAQ_PYLO_PercentPixelsToKeepForGradientTemplate =   107,//Specifies the percentage of gradient values that needs to be stored as part of the template. The default value is -1. The value -1 indicates an optimal value for the threshold will be computed. The minimum value is 5. The maximum value is 80.
    IMAQ_COMBINEDLEARNSETUPOPTION_SIZE_GUARD =	0xFFFFFFFF
} LearnSetupOption;

typedef enum MatchSetupOption_enum {
    // Preset-Parameters (for imaqMatchPattern)
        IMAQ_LDMO_MinimumContrast               =   0,           //Specifies the minimum expected difference between the maximum pixel value and the minimum pixel value in the inspection image.
        IMAQ_LDMO_EnableSubpixelAccuracy        =   1,           //Determines whether to return the match results with subpixel accuracy. Set this option to 1 to enable subpixel accuracy.The default value is 0, which disables subpixel accuracy.
        IMAQ_LDMO_SearchStrategy                =   2,           //Specifies the aggressiveness of the search strategy available during the matching phase.Three types of search strategies are available.The default is 2. (1) Conservative-Extracts template information for Conservative matching only. (2) Balanced-Extracts template information for Balanced and Conservative matching. (3) Aggressive-Extracts template information for Aggressive, Balanced, and Conservative matching.
        IMAQ_LDMO_SubpixelIterations            =   3,           //Specifies the maximum number of incremental improvements used to refine matches using subpixel information.The minimum value for this option is 20.
        IMAQ_LDMO_SubpixelTolerance             =   4,           //Specifies the maximum amount of change, in pixels, between consecutive incremental improvements in the match position before the VI stops refining the match position.The default value is 0, which specifies that the VI should always use a number of refinements equal to Subpixel Iterations. If you provide values for both Subpixel Iterations and Subpixel Tolerance, the VI refines the match for, at most, Subpixel Iterations but may stop early if Subpixel Tolerance is satisfied.
        IMAQ_LDMO_InitialMatchListLength        =   5,           //Specifies the maximum size of the match list. The match list contains the regions in the inspection image that have the highest probability of containing a match. The minimum value for this option is 5. The default value is 200.
        IMAQ_LDMO_MatchListReductionFactor      =   6,           //Specifies the reduction of the match list as matches are refined. The default is 5.
        IMAQ_LDMO_InitialStepSize               =   7,           //Specifies the number of template pixels that you want to include in a sample for the initial phase of matching. The default is 0, which allows the  algorithm to compute the Initial Sample Size. For optimal speed, the VI coerces sizes that are less than 240 to an integer multiple of 12 and coerces sizes greater than 240 to an integer multiple of 60.
        IMAQ_LDMO_IntermediateAngularAccuracy   =   8,           //Sets the angle accuracy, in degrees, to use during the final phase of the matching. The default is 1 degree. Use subpixel accuracy to achieve angle accuracy less than the default. This value must be no greater than the value for Initial Angular Accuracy. The VI coerces the angle to the largest integer smaller than it that evenly divides 360. This option is not used in conjunction with the Aggressive search strategy.
        // Pyramid Matching Options
	    IMAQ_PYMO_MaxPyramidLevel               =   100,         //Specifies the pyramid level at which the coarse-to-fine matching begins. The higher this value the faster the matching will be. Thus, setting this to 0 will lead to a very large match time. All values higher than the maximum allowed pyramid level (automatically computed during learning the template) are coerced to the maximum allowed level. The default value is set to the optimal pyramid level (automatically computed during learning the template). Note that setting this value lower than the Max Pyramid Level To Store Data (used in learning the template) is not allowed, as the required data for coarse matching will be missing. The IMAQ Get Template Information VI can be used to obtain the various pyramid levels used while learning the template and this parameter can then be set accordingly.
        IMAQ_PYMO_MinimumContrast               =   102,         //Specifies the minimum contrast to consider the image region for matching. Any image region lower than minimum contrast will be skipped for matching, which improves performance.
	    IMAQ_PYMO_EnableSubpixelAccuracy        =   103,         //Determines whether to return the match results with subpixel accuracy. Set this option to 1 to enable subpixel accuracy. The default value is 0, which disables subpixel accuracy.
	    IMAQ_PYMO_SubpixelIterations            =   104,         //Specifies the maximum number of incremental improvements used to refine matches using subpixel information. The minimum value for this option is 20.
	    IMAQ_PYMO_SubpixelTolerance             =   105,         //Specifies the maximum amount of change, in pixels, between consecutive incremental improvements in the match position before the VI stops refining the match position. The default value is 0, which specifies that the VI should always use a number of refinements equal to Subpixel Iterations. If you provide values for both Subpixel Iterations and Subpixel Tolerance, the VI refines the match for, at most, Subpixel Iterations but may stop early if Subpixel Tolerance is satisfied.
	    IMAQ_PYMO_InitialMatchListLength        =   106,         //Specifies the maximum size of the match list. The match list contains the regions in the inspection image that have the highest probability of containing a match. The minimum value for this option is 5. The default value is 200 for shift matching, and 300 for rotation matching. The value of -1 indicates that the algorithm will calculate the optimum value of the size of the match list for the given case.
	    IMAQ_PYMO_MatchListReductionFactor      =   107,         //Specifies the reduction of the match list as matches are refined. The default value is 1, which results in no reduction.
	    IMAQ_PYMO_IntermediateAngularAccuracy   =   108,         //Specifies the angular accuracy used for initial coarse matching when rotation is present. The default value is 6 degrees. Setting this value too high creates the risk of losing out matches.
	    IMAQ_PYMO_ProcessBorderMatches          =   109,         //Specifies whether to search for partial (border matches) or not. Note that the border could either be the image border or the border of the supplied ROI region. Turning this parameter on increases the match time, especially for larger templates. The default value is TRUE.
        IMAQ_PYMO_MinMatchSeparationDistance    =   111,         //Specifies the minimum separation distance, in pixels, between the origins of two matches that have unique positions. The VI does not return matches that have the same position and angle. The default value is 20.
        IMAQ_PYMO_MinMatchSeparationAngle       =   112,         //Specifies the minimum angular difference, in degrees, between two matches that have unique angles. The VI does not return matches that have the same position, scale, and angle. The default value is 10.
        IMAQ_PYMO_MaxMatchOverlap               =   113,         //Specifies the maximum amount of overlap, expressed as a percentage,  Overlap* (113) allowed between the bounding rectangles of two matches. The default value is 20.
        IMAQ_PYMO_MaxCacheSizeInMegabytes       =   114,         //Specifies the maximum cache size to use while matching for rotation. The cache is used to control the size of the template data in memory while matching. Cases where successive search images are expected to have matches which are either at same angle or at angles belonging to a small set of recurring values will see maximum cache utilization and speed-ups. The default value is -1 Megabytes, which indicates that an optimum value will be calculated and used.
        IMAQ_PYMO_ClearCacheOnEveryMatch        =   115,         //Specifies whether or not to flush the cache after every match. Turning this ON will take away the caching benefits seen for successive match images having matches at the same angle or at recurring angles. The default value is OFF.
        IMAQ_PYMO_EnableAccurateScoreComputatation = 116,        //Specifies whether to calculate an accurate score for the match based on subpixel location.
        IMAQ_PYMO_InterpolationForAccurateScoreComputation = 117,//Specifies the interpolation algorithm to be used while calculating the score. The image is interpolated using either of the below algorithms. (0) Zero Order - No Interpolation. (1) Bilinear - The intermediate pixels are linearly interpolated. (1) is the default value.
        IMAQ_PYMO_TargetToTemplateScore = 118,                   //Set this to 1 to enable recomputing Match Score based on higher match regions between the template and matched section of the image. For Example, if a matched object is occluded, Target to Template Score may remove occluded regions from score computation and consider the regions which are matching with the template.
    // Non Preset-Parameters(for imaqMatchPattern)
        // ScoreMap Options
        IMAQ_ALLMO_EnableScoreMap = 200,                         //Specifies whether or not to calculate the defect map between the template and match image.The default value is OFF.
    IMAQ_COMBINEDMATCHSETUPOPTION_IS_AN_INT = 0xFFFFFFFF
} MatchSetupOption;
...
typedef enum PolarityType_enum {
    ...
    IMAQ_POLARITY_TYPE_SIZE_GUARD = 0x7FFFFFFF
} PolarityType;
...
typedef enum Tool_enum {
    ...
    IMAQ_TOOL_SIZE_GUARD      = 0x7FFFFFFF
} Tool;
...
typedef enum BarcodeType_enum {
    ...
    IMAQ_BARCODE_TYPE_SIZE_GUARD = 0x7FFFFFFF
} BarcodeType;
...
typedef enum MatchingAlgorithm_enum {
	IMAQ_MATCH_ALLALGORITHMS		  =	0,			 //Searches for occurences of the pattern in the image using all algorithms
    IMAQ_MATCH_LOW_DISCREPANCY    = 1,           //Searches for occurences of the pattern in the image using low discrepancy sampling method
    IMAQ_MATCH_GRAYVALUE_PYRAMID  = 2,           //Searches for occurrences of the pattern in the image using a grayscale pyramid method
    IMAQ_MATCH_GRADIENT_PYRAMID   = 3,           //Searches for occurrences of the pattern in the image using a gradient pyramid method
	IMAQ_MATCHING_ALGORITHM_SIZE_GUARD = 0xFFFFFFFF
} MatchingAlgorithm;

typedef enum PatternMatchPresetFunction_enum {
    IMAQ_SET_DEFAULT_OPTIONS        = 1,           //Clears any Custom and Preset match parameters.
    IMAQ_SET_PRESET_OPTIONS         = 2,           //Stores Preset match parameters according to Preset options provided.
    IMAQ_PRESET_FUNCTION_SIZE_GUARD = 0xFFFFFFFF
} PatternMatchPresetFunction;

typedef enum PatternMatchPresetType_enum {
    IMAQ_PRESET_USE_CASE        = 0,           //Specifies the Match Requirement.
    IMAQ_PRESET_PRIORITY        = 1,           //Specifies the relative priority of Match accuracy and Match speed.
    IMAQ_PRESET_TYPE_SIZE_GUARD = 0xFFFFFFFF
} PatternMatchPresetType;
...
typedef enum CastingMethod_enum {
    IMAQ_USE_BIT_DEPTH             = 0,         // The function uses bit depth information of the image to perform casting operation.
    IMAQ_USE_SHIFT                 = 1,         // The function uses the numberOfShifts input to perform casting operation.
    IMAQ_USE_LOOKUP_TABLE          = 2,         // The function uses lookupTable input to perform casting operation.
    IMAQ_CASTING_METHOD_SIZE_GUARD = 0xFFFFFFFF
} CastingMethod;
...
typedef enum ThresholdType_enum {
    IMAQ_GLOBAL_THRESHOLD       = 0,             //Performs global threshold depending on the mode selected from ThresholdMode
    IMAQ_LOCAL_THRESHOLD        = 1,             //The function performs background correction first to eliminate non-uniform lighting effects, then performs thresholding using the Otsu thresholding algorithm.
    IMAQ_COLOR_THRESHOLD        = 2,             //Applies threshold to the threes planes of a RGB, HSL, HSV or HSI plane
    IMAQ_THRESHOLD_TYPE_SIZE_GUARD = 0xFFFFFFFF
} ThresholdType;

typedef enum LineSeparator_enum{
    IMAQ_END_OF_LINE_CONSTANT   = 0,        // Inserts \n\r as line separator for multiline read string and uses \n\r to count the lines from multiline string to be trained
    IMAQ_LINE_FEED              = 1,        // Inserts \n as line separator for multiline read string and uses \n\r to count the lines from multiline string to be trained
    IMAQ_CARRIAGE_RETURN        = 2,        // Inserts \r as line separator for multiline read string and uses \n\r to count the lines from multiline string to be trained
    IMAQ_LINE_SEPARATOR_SIZE_GUARD = 0xFFFFFFFF
}LineSeparator;
...
typedef enum WaveletType_enum {
    IMAQ_DB02                 = 0,           //Daubechies wavelet.
    IMAQ_DB03                 = 1,           //Daubechies wavelet.
    IMAQ_DB04                 = 2,           //Daubechies wavelet.
    IMAQ_DB05                 = 3,           //Daubechies wavelet.
    IMAQ_DB06                 = 4,           //Daubechies wavelet.
    IMAQ_DB07                 = 5,           //Daubechies wavelet.
    IMAQ_DB08                 = 6,           //Daubechies wavelet.
    IMAQ_DB09                 = 7,           //Daubechies wavelet.
    IMAQ_DB10                 = 8,           //Daubechies wavelet.
    IMAQ_DB11                 = 9,           //Daubechies wavelet.
    IMAQ_DB12                 = 10,          //Daubechies wavelet.
    IMAQ_DB13                 = 11,          //Daubechies wavelet.
    IMAQ_DB14                 = 12,          //Daubechies wavelet.
    IMAQ_HAAR                 = 13,          //Haar wavelet.
    IMAQ_BIOR1_3              = 14,          //Biorthogonal wavelet.
    IMAQ_BIOR1_5              = 15,          //Biorthogonal wavelet.
    IMAQ_BIOR2_2              = 16,          //Biorthogonal wavelet.
    IMAQ_BIOR2_4              = 17,          //Biorthogonal wavelet.
    IMAQ_BIOR2_6              = 18,          //Biorthogonal wavelet.
    IMAQ_BIOR2_8              = 19,          //Biorthogonal wavelet.
    IMAQ_BIOR3_1              = 20,          //Biorthogonal wavelet.
    IMAQ_BIOR3_3              = 21,          //Biorthogonal wavelet.
    IMAQ_BIOR3_5              = 22,          //Biorthogonal wavelet.
    IMAQ_BIOR3_7              = 23,          //Biorthogonal wavelet.
    IMAQ_BIOR3_9              = 24,          //Biorthogonal wavelet.
    IMAQ_BIOR4_4              = 25,          //Biorthogonal wavelet.
    IMAQ_COIF1                = 26,          //Coiflets wavelet.
    IMAQ_COIF2                = 27,          //Coiflets wavelet.
    IMAQ_COIF3                = 28,          //Coiflets wavelet.
    IMAQ_COIF4                = 29,          //Coiflets wavelet.
    IMAQ_COIF5                = 30,          //Coiflets wavelet.
    IMAQ_SYM2                 = 31,          //Symmlets wavelet.
    IMAQ_SYM3                 = 32,          //Symmlets wavelet.
    IMAQ_SYM4                 = 33,          //Symmlets wavelet.
    IMAQ_SYM5                 = 34,          //Symmlets wavelet.
    IMAQ_SYM6                 = 35,          //Symmlets wavelet.
    IMAQ_SYM7                 = 36,          //Symmlets wavelet.
    IMAQ_SYM8                 = 37,          //Symmlets wavelet.
    IMAQ_BIOR5_5              = 38,          //Biorthogonal wavelet.
    IMAQ_BIOR6_8              = 39,          //Biorthogonal wavelet.
...
typedef enum QRCellFilterMode_enum {
    ...
    IMAQ_QR_CELL_FILTER_MODE_SIZE_GUARD        = 0x7FFFFFFF
} QRCellFilterMode;
...
typedef enum QRCellSampleSize_enum {
    ...
    IMAQ_QR_CELL_SAMPLE_TYPE_SIZE_GUARD  = 0x7FFFFFFF
} QRCellSampleSize;
...
typedef enum QRDemodulationMode_enum {
    ...
    IMAQ_QR_DEMODULATION_MODE_SIZE_GUARD     = 0x7FFFFFFF
} QRDemodulationMode;
...
typedef enum QRMirrorMode_enum {
    ...
    IMAQ_QR_MIRROR_MODE_SIZE_GUARD  = 0x7FFFFFFF
} QRMirrorMode;
...
typedef enum QRPolarities_enum {
    ...
    IMAQ_QR_POLARITY_MODE_SIZE_GUARD = 0x7FFFFFFF
} QRPolarities;
...
typedef enum CalibrationThumbnailType_enum {
    IMAQ_CAMARA_MODEL_TYPE                     = 0,           //Camera model thumbnail type.
...
typedef enum StereoBlockMatchMetric_enum {
    IMAQ_SUM_ABSOLUTE_DIFF      = 0,
    IMAQ_SUM_SQUARED_DIFF       = 1,
    IMAQ_CORRELATION            = 2,
    IMAQ_MATCH_METRIC_IS_AN_INT = 0xFFFFFFFF,
} StereoBlockMatchMetric;

typedef enum StereoPrefilterType_enum {
    IMAQ_STEREO_BM_NONE                = 0,
    IMAQ_STEREO_BM_NORMALIZED_RESPONSE = 1,
    IMAQ_STEREO_BM_XSOBEL              = 2,
    IMAQ_PREFILTER_TYPE_IS_AN_INT      = 0xFFFFFFFF,
} StereoPrefilterType;

typedef enum StereoCameraPosition_enum {
    IMAQ_STEREO_LEFT                      = 0,
    IMAQ_STEREO_RIGHT                     = 1,
    IMAQ_STEREO_CENTER                    = 2,
    IMAQ_STEREO_CAMERA_POSITION_IS_AN_INT = 0xFFFFFFFF,
} StereoCameraPosition;

typedef enum StereoSessionWriteOptions_enum {
    IMAQ_KWRITE_OPTIONS_FIRST        = -1,
    IMAQ_KFULL                       = 0,
    IMAQ_COMPACT                     = 1,
    IMAQ_WRITEOPTIONS_LAST           = 2,
    IMAQ_SURE_WRITEOPTIONS_IS_AN_INT = 0x7FFFFFFF,
} StereoSessionWriteOptions;

typedef enum DataMatrixAdvancedProcessing_enum {
    IMAQ_START_OF_PROCESSING                    = -1,
    IMAQ_LINE_DETECTION                         = 0,    //Enables the line detection algorithm.
    IMAQ_HIGHLIGHT_FILTER                       = 1,    //Enables the highlight filter.
    IMAQ_AGGRESSIVE_PROCESSING                  = 2,    //Enables aggressive reading.
    IMAQ_ENABLEFNC1                             = 3,    //Enables decoding of FNC1 characters.
    IMAQ_REFINE_BOUNDING_BOX                    = 4,    //Enables refining the location of the bounding box.
    IMAQ_END_OF_PROCESSING                      = 5,    //.
    IMAQ_MAKE_SURE_ADVANCEDPROCESSING_IS_AN_INT = 0x7FFFFFFF,
} DataMatrixAdvancedProcessing;

typedef enum RadialCoefficients_enum {
    IMAQ_COEFF_K1             = 0,           //One radial coefficient is considered.
    IMAQ_COEFF_K1_K2_K3       = 1,           //Three radial coefficients are considered.
    IMAQ_COEFF_K1_K2_K3_K4_K5 = 2,           //Five radial coefficients are considered.
    IMAQ_COEFF_SIZE_GUARD     = 0xFFFFFFFF
} RadialCoefficients;
...
typedef enum ParticleClassifierThresholdType_enum {
    ...
    IMAQ_PARTICLECLASSIFIER_THRESHOLDTYPE_SIZE_GUARD = 0xFFFFFFFF
...
typedef enum DistortionModel_enum {
    ...
    IMAQ_DISTORTION_MODEL_SIZE_GUARD = 0X7FFFFFFF
} DistortionModel;
...
typedef enum GeometricSetupDataItem_enum {
    // Preset-Parameters (for imaqMatchGeometricPattern)
	    ...
	    IMAQ_SCORING_METHOD                      = 26,
	    IMAQ_INITIAL_MATCH_ANGULAR_ACCURACY      = 27,
    // Non Preset-Parameters (for imaqMatchGeometricPattern)
        ...
        IMAQ_ENABLE_DEFECT_MAP = 28,
    IMAQ_GEOMETRIC_SETUPDATA_ITEMSIZE_GUARD  = 0xFFFFFFFF
...
typedef enum LocalThresholdMethod_enum {
    ...
    IMAQ_SAUVOLA                           = 2,           //The function computes threshold for each pixel similar to Niblack but with an additional parameter, Sauvola Deviation Range(R).
    IMAQ_MODIFIED_SAUVOLA                  = 3,
...
typedef enum StereoInterpolationType_enum {
    IMAQ_KIPTYPEZEROORDER        = 0,
    IMAQ_KIPTYPEBILINEAR         = 1,
    IMAQ_KIPTYPEQUADRATIC        = 2,
    IMAQ_kIPTYPECUBICSPLINE      = 3,
    IMAQ_KIPTYPEBILINEARFIXED    = 4,
    IMAQ_INTERPLOATION_IS_AN_INT = 888,
} StereoInterpolationType;
...
typedef enum DataMatrixPolarity_enum {
    ...
    IMAQ_DATA_MATRIX_POLARITY_SIZE_GUARD = 0x7FFFFFFF
} DataMatrixPolarity;
...
typedef enum DataMatrixCellFillMode_enum {
    ...
    IMAQ_DATA_MATRIX_CELL_FILL_MODE_SIZE_GUARD = 0x7FFFFFFF
...
typedef enum DataMatrixECC_enum {
    ...
    IMAQ_DATA_MATRIX_ECC_SIZE_GUARD = 0x7FFFFFFF
} DataMatrixECC;
...
typedef enum VisionInfoType2_enum {
    ...
    IMAQ_VISIONINFO_CONTOURDATA              = 0x100,       //Used to indicate interaction with the contour information in an image.
    IMAQ_VISIONINFO_CAMERAMODEL              = 0x200,       //Used to indicate interaction with the camera model information in an image.
    IMAQ_VISIONINFO_PYRAMIDGRAYVALUETEMPLATE = 0x400,       //Used to indicate interaction with the pyramid grayvalue template information in an image.
    IMAQ_VISIONINFO_PYRAMIDGRADIENTTEMPLATE  = 0x800,       //Used to indicate interaction with the pyramid gradient template information in an image.
...
typedef enum DataMatrixCellFilterMode_enum {
    ...
    IMAQ_DATA_MATRIX_CELL_FILTER_MODE_SIZE_GUARD = 0x7FFFFFFF
...
typedef enum DataMatrixCellSampleSize_enum {
    ...
    IMAQ_DATA_MATRIX_CELL_SAMPLE_SIZE_SIZE_GUARD = 0x7FFFFFFF
...
typedef enum DataMatrixMirrorMode_enum {
    ...
    IMAQ_DATA_MATRIX_MIRROR_MODE_SIZE_GUARD = 0x7FFFFFFF
...
typedef enum DataMatrixDemodulationMode_enum {
    ...
    IMAQ_DATA_MATRIX_DEMODULATION_MODE_SIZE_GUARD = 0x7FFFFFFF
} DataMatrixDemodulationMode;

typedef enum RTVideoModeOperation_enum {
    IMAQ_GET_MODE                   = 0,              //Get the current video mode
    IMAQ_SET_MODE                   = 1,              //Set the video mode
    IMAQ_RT_VIDEO_MODE_SIZE_GUARD   = 0XFFFFFFFF

} RTVideoModeOperation;

typedef enum RTDisplayVideoMode_enum {
    IMAQ_TEXT_MODE                       = 0,          //The function sets the video mode to text
    IMAQ_GRAPHICS_MODE                   = 1,          //The function sets the video mode to graphics
    IMAQ_DISPLAY_VIDEO_MODE_SIZE_GUARD   = 0XFFFFFFFF
} RTDisplayVideoMode;

typedef enum BGEstimateMethod_enum{
    IMAQ_MODEL           = 0,                                // The function uses model for estimating the background
    IMAQ_BG_CORRECTION   = 1,                                // The function uses Background Correction thresholing for estimating the background
    IMAQ_BG_NIBLACK      = 2,                                // The function uses NiBlack thresholding for estimating the background
    IMAQ_BGESTIMATE_METHOD_SIZE_GUARD = 0xFFFFFFFF
} BGEstimateMethod;

typedef enum SVMType_enum {
    IMAQ_C_SVC              = 0, //Allows the SVM algorithm to clearly separate samples that are separated by a very narrow margin.
    IMAQ_NU_SVC             = 1, //The Nu parameter controls training errors and the number of support vectors.
    IMAQ_ONE_CLASS          = 2, //(Default)The SVM algorithm considers the spatial distribution information for each sample to determine whether the sample belongs to the known class.
    IMAQ_IMAQ_SVMTYPE_GUARD = 0xFFFFFFFF
} SVMType;

typedef enum KernelType_enum {
    IMAQ_LINEARSVM             = 0, //Applies a linear kernel to the sample. Use this kernel If the number of features per sample is high.
    IMAQ_POLYNOMIAL            = 1, //Applies a polynomial kernel to the sample.
    IMAQ_GAUSSIAN              = 2, //Applies a Gaussian kernel to the sample.
    IMAQ_RBF                   = 3, //(Default)Applies a radial basis function (RBF) kernel to the sample.
    IMAQ_KERNELTYPE_GUARD = 0xFFFFFFFF
} KernelType;

typedef enum CornerOperators_enum{
    IMAQ_HARRISCORNER=0,  // Harris Corner Detection will be applied to Detect Corners
    IMAQ_SHICORNER=1,     // Shi Tomasi Corner Detection will be applied to Detect Corners
    IMAQ_CORNEROPERATORS_GUARD = 0xFFFFFFFF
}CornerOperators;

typedef enum VelocityRepresentation_enum{
	IMAQ_CARTESIAN                          =  0,        //Uses Cartesian representation
	IMAQ_POLAR                              =  1,	     //Uses Polar representation
	IMAQ_VELOCITY_REPRESENTATION_SIZE_GUARD = 0XFFFFFFFF
} VelocityRepresentation;

typedef enum StoppingType_enum {
	IMAQ_ITERATIONS = 1,                                //Specifies that the computation should stop after the number of iterations
	IMAQ_EPSILON    = 2,                                //Specifies the computation should stop after the value of Epsilon has been reached
	IMAQ_BOTH       = 3,                                //Specifies the computation should stop after the maximum iterations and Epsilon value have both been reached
	IMAQ_STOPPINGTYPE_SIZE_GUARD = 0XFFFFFFFF
}StoppingType;

typedef enum ObjectTrackingMethod_enum {
    IMAQ_MEANSHIFTTRADITIONAL  = 0, //MeanShift Method.
    IMAQ_SHAPEADAPTEDMEANSHIFT = 1, //Shape Adapted Meanshift Method.
    IMAQ_OBJECTTRACKINGMETHOD_SIZE_GUARD = 0XFFFFFFFF
} ObjectTrackingMethod;

typedef enum ObjectDescriptionMethod_enum {
    IMAQ_HISTOGRAMBASED = 0, //Histogram Based Object Description.
    IMAQ_OBJECTDESCRIPTIONMETHOD_SIZE_GUARD = 0XFFFFFFFF
} ObjectDescriptionMethod;

// enum for converting objects
typedef enum InterchangeObjectTrackingMethods_enum {
    IMAQ_NOCHANGE = 0, //No Change.
    IMAQ_MSTOMS   = 1, //Mean Shift method to Meanshift conversion.
    IMAQ_MSTOEMS  = 2, //Mean Shift to Shape Adapted Meanshift conversion.
    IMAQ_EMSTOMS  = 3, //Shape Adapted Meanshift to Meanshift conversion.
    IMAQ_EMSTOEMS = 4, //Shape Adapted Meanshift to Shape Adapt Meanshift conversion.
    IMAQ_INTERCHANGEOBJECTTRACKINGMETHODS_SIZE_GUARD = 0XFFFFFFFF
} InterchangeObjectTrackingMethods;

//enum for feature extraction methods
typedef enum FeatureExtractionMethods_enum{
    IMAQ_HOG = 0,  //Histogram of Gradient features
    IMAQ_LBP = 1,  //Local Binary Pattern features
	IMAQ_FEATUREEXTRACTIONMETHODS_SIZE_GUARD = 0XFFFFFFFF
}FeatureExtractionMethods;

// enum for feature description
typedef enum FeatureDescriptionMethoods_enum{
    IMAQ_FREAK = 0,  // Fast Retina Keypoint method
    IMAQ_BRISK = 1,  // Binary Robust Invariant Scalable Keypoint method
    IMAQ_FEATUREDESCRIPTIONMETHODS_SIZEGUARD = 0XFFFFFFFF
}FeatureDescriptionMethods;

// enum for MIPI CSI-2 data format
// values are directly from the CSI-2 specification for these data types
typedef enum MipiCsi2Format_enum{
    IMAQ_MIPICSI2FORMAT_NONE        = 0x0,
    IMAQ_MIPICSI2FORMAT_YUV422_8BIT = 0x1E,
    IMAQ_MIPICSI2FORMAT_RGB888      = 0x24,
    IMAQ_MIPICSI2FORMAT_SIZE_GUARD  = 0XFFFFFFFF
} MipiCsi2Format;
...
typedef struct StereoSession_struct StereoSession;
...
typedef struct ObjectTrackingSession_struct ObjectTrackingSession;
typedef void* AVI2Session;
...
typedef struct StereoLearnCalibQualiy_struct {
    double dProjectionError; // Specifies the maximum error in the stereo camera calibration
    double dcalibQuality;    // Value between 0 and 1
    double dmaxRectError;    // Specifies how well the rectified images are aligned
    double drectQuality;     // Specifies the quality of the rectification process
} StereoLearnCalibQualiy;

typedef struct StereoRtfSettings_struct {
    unsigned int iLearnLookup;             // Specifies whether lookup tables need to be learned to rectify the left and right images
    unsigned int iRenderToOriginalImage;   // Specifies whether to learn a lookup table for mapping the disparity image to the original left image
    unsigned int iScalingFactor;           // A value between 0 and 1
} StereoRtfSettings;

typedef struct StereoPrefilterOptions_struct {
    StereoPrefilterType filterType;        // Specifies the type of filtering operation that is applied to the input images
    unsigned int        filterSize;        // Specifies the size of the filter. It must be odd
    unsigned int        filterCap;         // Specifies the filter cap
} StereoPrefilterOptions;

typedef struct StereoBlockMatchingOptions_struct {
    StereoBlockMatchMetric metric;                     //Specifies the metric that is used to compute matches between the left and right images
    unsigned int           windowSize;                 //The size of the window that is used to compute the matching score at each pixel in the image
    int                    minDisparity;               //The minimum distance between the same point in the left and right rectified images
    unsigned int           numDisparities;             //Maximum distance (disparity) between the same point in the left and right rectified images
    int                    maxLeftRightDisparityDiff;  //Specifies the maximum allowed difference in the disparity value
    short                  subpixel;                   //Computes the disparities with subpixel accuracy when enabled
    float                  pixelReplaceVal;            //Pixel value assigned to invalid disparity values in the output Disparity Image
} StereoBlockMatchingOptions;

typedef struct StereoSGBlockMatchingOptions_struct{
    StereoBlockMatchMetric metric;                      //Specifies the metric that is used to compute matches between the left and right images
    unsigned int           windowSize;                  //The size of the window that is used to compute the matching score at each pixel in the image
    unsigned int           minDisparity;                //The minimum distance between the same point in the left and right rectified images
    unsigned int           numDisparities;              //Maximum distance (disparity) between the same point in the left and right rectified images
    int                    p1;                          //Specifies the cost of changing the disparity value by a unit value during the updating process
    int                    p2;                          //Specifies the amount of smoothing applied to the disparity image
    short                  fullDP;                      //If TRUE, will run the block matching algorithm through mulitple iterations using dynamic programming.
    int                    maxLeftRightDisparityDiff;   //Specifies the maximum allowed difference in the disparity value
    short                  subpixel;                    //Computes the disparities with subpixel accuracy when enabled
    float                  pixelReplaceVal;             //Pixel value assigned to invalid disparity values in the output Disparity Image
}StereoSGBlockMatchingOptions;

typedef struct StereoDepthControl_struct {
    double dMinDepth;     //Specifies Minimum Depth
    double dMaxDepth;     //Specifies Maximum Depth
} StereoDepthControl;

typedef struct StereoPostfilterOptions_struct {
    unsigned int textureThreshold;       //Specifies the minimum sum of absolute value (SAD) at each pixel to be considered to be a valid disparity
    unsigned int uniquenessRatio;        //Specifies how unique the match at each pixel should be to considered as valid
    unsigned int speckleWindowSize;      //Specifies the maximum allowed deviation in neighboring pixels disparity values
    unsigned int speckleRange;           //Defines the number of neighboring pixel disparities the speckle filter must locate before a given pixel disparity is considered valid
} StereoPostfilterOptions;
...
typedef struct OCRSpacingOptions2_struct {
    ...
    int textLocation;                //Set this element to TRUE to enable multiple line detection and locate the texts with weak rotation
    LineSeparator  lineSeparator;    //The line separator is used to separate the multiple text lines. This is used to determine number of lines when using with imaqTrainChars and separate the string lines returned by imaqReadText4
    int shortestPathSegment;         //Set this element to TRUE to automatically segment the vertically merged character using shortest path segment algorithm
    int minPixelsForSpace;           //The minimum number of pixel width required between two characters to force the space character in read string
} OCRSpacingOptions2;

typedef struct OCRProcessingOptions2_struct {
    ThresholdType thresholdType;              //The thresholding type {IMAQ GLOBAL_THRESHOLD, IMAQ_LOCAL_THRESHOLD, IMAQ_COLOR_THRESHOLD}
    ThresholdMode mode;                       //The thresholding mode for IMAQ_GLOBAL_THRESHOLD
    ...
    unsigned int  windowWidth;                //Width of window in pixels for Local Threshold when you threshold type to IMAQ LOCAL_THRESHOLD
    unsigned int  windowHeight;               //Height of window in pixels for Local Threshold when you threshold type to IMAQ LOCAL_THRESHOLD
    ColorMode     colorMode;                  //The color thresholding mode when you set thresholdType to IMAQ_COLOR_THRESHOLD
    Range         plane1Range;                //The thresholding range for red or hue plane depending on the color mode
    Range         plane2Range;                //The thresholding range for green or saturation plane depending on the color mode
    Range         plane3Range;                //The thresholding range for the blue, luminance, value, or intensity plane, depending on the color mode
...
typedef struct ReadTextReport4_struct {
    ...
    int          numberOflinesDetected; //The detected number of text lines
} ReadTextReport4;

typedef struct CalibReflectanceStruct_struct {
    double rcal;     //The reported reflectance/Rmax value of the calibration standard.
    double srcal;    //The system response parameters (such as exposure and/or gain) used to create an image of the calibration standard.
    double mlcal;    //The mean light from a histogram of the calibrated standard.
    double srtarget; //The system response parameters (such as exposure and/or gain) used to create a data matrix image of the symbol under test.
} CalibReflectanceStruct;

typedef struct AdvancedDataMatrixOptions_struct {
    DataMatrixAdvancedProcessing type;  //Specifies the option the VI uses when reading the data matrix.
    double                       value; //Specifies whether to use the selected option.
} AdvancedDataMatrixOptions;

typedef struct AIMDPMGradeReport_struct {
    ...
    AIMGrade cellContrastGrade;          //The letter grade assigned to a Data Matrix code based on the cell contrast raw score.
    float    cellContrast;               //The cell contrast raw score representing the difference between the mean light and the mean dark of the symbol histogram.
    ...
    AIMGrade gridNonUniformityGrade;     //The letter grade assigned to a Data Matrix code based on the grid nonuniformity raw score.
    float    gridNonUniformity;          //The grid nonuniformity raw score for the Data Matrix code, which is the largest vector deviation of the grid intersections, determined by the reference decode algorithm from the binarized image of a given symbol, from their ideal theoretical position.
    AIMGrade cellModulationGrade;        //The letter grade assigned to a Data Matrix code based on the modulation raw score.
    AIMGrade fixedPatternDamageGrade;    //The letter grade assigned to a Data Matrix code based on the fixed pattern damage.
    float    fixedPatternDamage;         //The fixed pattern damage raw score for the Data Matrix code, which is the extent of damage in the finder pattern and quiet zone pattern.
    AIMGrade minimumReflectanceGrade;    //The letter grade assigned to a Data Matrix code based on the minimum reflectance raw score.
    float    minimumReflectance;         //The minimum reflectance raw score for the Data Matrix code, which is the ratio of the parts reflectance to the calibrated reflectance.
} AIMDPMGradeReport;

typedef struct GradeReportISO15415_struct {
    AIMGrade overallGrade;               //The overall letter grade, which is equal to the lowest of the other five letter grades.
    AIMGrade decodingGrade;              //The letter grade assigned to a Data Matrix barcode based on the success of the function in decoding the Data Matrix barcode.
    ...
    AIMGrade gridNonUniformityGrade;     //The letter grade assigned to a Data Matrix code based on the grid nonuniformity raw score.
    float    gridNonUniformity;          //The grid nonuniformity raw score for the Data Matrix code, which is the largest vector deviation of the grid intersections, determined by the reference decode algorithm from the binarized image of a given symbol, from their ideal theoretical position.
    AIMGrade modulationGrade;
    AIMGrade fixedPatternDamageGrade;    //The letter grade assigned to a Data Matrix code based on the fixed pattern damage.
    float    fixedPatternDamage;         //The fixed pattern damage raw score for the Data Matrix code, which is the extent of damage in the finder pattern and quiet zone pattern.
} GradeReportISO15415;

typedef struct GradeReportISO16022_struct {
    AIMGrade overallGrade;               //The overall letter grade, which is equal to the lowest of the other five letter grades.
    AIMGrade decodingGrade;              //The letter grade assigned to a Data Matrix barcode based on the success of the function in decoding the Data Matrix barcode.
    AIMGrade symbolContrastGrade;        //The letter grade assigned to a Data Matrix barcode based on the symbol contrast raw score.
    float    symbolContrast;             //The symbol contrast raw score representing the percentage difference between the mean of the reflectance of the darkest 10 percent and lightest 10 percent of the Data Matrix barcode.
...
typedef struct CalibrationCorrectionLearnSetupInfo_struct {
    ScalingMethod  scaleMode;            //Corrected Image Scaling defines the aspect scaling to use when correcting an image.
    CalibrationROI roiMode;              //Specifies the ROI to use when correcting an image.
    char           learnCorrectionTable; //Set this input to 1 if you want the correction table to be determined and stored.
} CalibrationCorrectionLearnSetupInfo;

typedef struct CalibrationModelSetup_struct {
    DistortionModel    distortionModel;        //Type of learned distortion model.
    RadialCoefficients radialCoefficient;      //Specify the radial coefficients for the model.
    int                tangentialCoefficients; //Specify the tangential coefficients for the model.
} CalibrationModelSetup;
...
typedef struct GetCameraParametersReport_struct {
    ...
    size_t					projectionMatrixRows; //Number of rows in projection matrix.
    size_t					projectionMatrixCols; //Number of columns in projection matrix.
    DistortionModelParams	distortion;           //Distortion model coefficients.
    InternalParameters		internalParams;       //The learned internal parameters of camera model such as focal length and optical center.
...
typedef struct CalibrationAxisInfo_struct {
    ...
    AxisOrientation axisDirection; //Specifies the direction of the calibration axis which is either Direct or Indirect.
} CalibrationAxisInfo;
...
typedef struct ErrorStatistics_struct {
    ...
    double standardDeviation; //The standard deviation error statistics value.
...
typedef struct GetCalibrationInfoReport_struct {
    ...
    size_t						errorMapRows;    //Number of rows in error map.
    size_t						errorMapCols;    //Number of Columns in error map.
...
typedef struct BarcodeInfo2_struct {
    unsigned char* data;
    ...
    PointFloat* boundingBox;
    unsigned int numBox;
} BarcodeInfo2;

typedef struct Barcode1DSearchOptions_struct {
    unsigned int minBarcodeWidth;
    unsigned int minEdgeStrength;
    unsigned int minBars;
    int skipLocationSearch;
} Barcode1DSearchOptions;
...
typedef struct CornerOption_struct
{
	CornerOperators detectorType;    // It is an enum having two types of corner detectors : Harris and SHiTomasi
    int kernelSize;                    // The size of the kernel used to find gradients of the image
	double minCornerPointStrength;                  // The corner strength/ threshold below which the point will not be considered a corner
}CornerOption;
...
typedef struct ClassifiedCurve_struct {
    ...
    unsigned int label;            //specifies the class to which the sample belongs.
...
typedef struct RangeLabel_struct {
    ...
    unsigned int label; //Class Label specifies the class to which the sample belongs.
} RangeLabel;
...
typedef struct ExtractTextureFeaturesReport_struct {
    int*     waveletBands;        //The array of wavelet bands used for extraction.
    int      numWaveletBands;     //The number of waveletBands in the array.
    double** textureFeatures;     //A 2-D array that stores the texture features extracted.
    int      textureFeaturesRows; //The number of rows in the textureFeatures array.
    int      textureFeaturesCols; //The number of columns in the textureFeatures array.
} ExtractTextureFeaturesReport;

typedef struct WaveletBandsReport_struct {
    float** LLBand;  //2-D array for Low Low Band.
    float** LHBand;  //2-D array for Low High Band.
    float** HLBand;  //2-D array for High Low Band.
    float** HHBand;  //2-D array for High High Band.
    float** LLLBand; //2-D array for Low Low Low Band.
    float** LLHBand; //2-D array for Low Low High Band.
    float   LHLBand; //2-D array for Low High Low Band.
    float** LHHBand; //2-D array for Low High High Band.
    int     rows;    //Number of rows for the 2-D array.
    int     cols;    //Number of columns for the 2-D array.
} WaveletBandsReport;
...
typedef struct FindConcentricEdgeReport_struct {
    ...
    double     avgStrength;       //Average strength of the edge found.
...
typedef struct WindowSize_struct {
    int x;        //The size of the window in the x dimension.
    int y;        //The size of the window in the y dimension.
    int stepSize; //The amount by which the window is moved across the image in the horizontal and vertical direction.
} WindowSize;

typedef struct DisplacementVector_struct {
    int x; //The distance in the horizontal direction.
    int y; //The distance in the vertical direction.
} DisplacementVector;

typedef struct WaveletOptions_struct {
    WaveletType typeOfWavelet; //Specifies the wavelet type to use for the discrete wavelet analysis.
    float       minEnergy;     //Specifies the minimum amount of energy that should be present in the wavelet bands to consider for texture defect detection.
} WaveletOptions;

typedef struct CooccurrenceOptions_struct {
    int                level;        //Specifies the number of gray levels the image is quantized to before the co-occurrence matrix is computed.
    DisplacementVector displacement; //Specifies the distance of the neighboring pixels to consider when computing the co-occurrence matrix.
} CooccurrenceOptions;
...
typedef struct MatchGeometricPatternAdvancedOptions4_struct {
	unsigned int                    subpixelIterations;          //Specifies the maximum number of incremental improvements used to refine matches with subpixel information.
	double                          subpixelTolerance;           //Specifies the maximum amount of change, in pixels, between consecutive incremental improvements in the match position before the function stops refining the match position.
	unsigned int                    initialMatchListLength;      //Specifies the maximum size of the match list.
	int                             targetTemplateCurveScore;    //Set this element to TRUE to specify that the function should calculate the match curve to template curve score and return it for each match result.
	...
	unsigned int                    refineMatchFactor;           //Specifies the factor that is applied to the number of matches requested by the user to determine the number of matches that are refined at the initial matching stage.
	unsigned int                    subpixelMatchFactor;         //Specifies the factor that is applied to the number of matches requested by the user to determine the number of matches that are evaluated at the final subpixel matching stage.
	unsigned int					contourMaxRefinements;		 // allows contour matching to perform additional refinements
	unsigned int					scoringMethod;				 // Specifies the method used to compute the output match scores
	unsigned int					initialMatchAngularAccuracy; // Specifies the angular accuracy to be used for initial match
} MatchGeometricPatternAdvancedOptions4;

typedef struct MatchGeometricPatternAdvancedOptions5_struct {
	unsigned int                    subpixelIterations;          //Specifies the maximum number of incremental improvements used to refine matches with subpixel information.
	double                          subpixelTolerance;           //Specifies the maximum amount of change, in pixels, between consecutive incremental improvements in the match position before the function stops refining the match position.
	unsigned int                    initialMatchListLength;      //Specifies the maximum size of the match list.
	int                             targetTemplateCurveScore;    //Set this element to TRUE to specify that the function should calculate the match curve to template curve score and return it for each match result.
	...
	unsigned int					scoringMethod;				 // Specifies the method used to compute the output match scores
	unsigned int					initialMatchAngularAccuracy; // Specifies the angular accuracy to be used for initial match
	unsigned int					enableDefectMap;             // Enables / Disables the DefectMap calculation
} MatchGeometricPatternAdvancedOptions5;
...
typedef enum CodecSource_enum {
	AVI_DEFAULT_CODEC = 0,
	AVI_VFW_CODEC = 1,
	AVI_FFMPEG_CODEC = 2,
	IMAQ_CODEC_SOURCE_TYPE_SIZE_GUARD = 0xFFFFFFFF
} CodecSourceType;

typedef struct LearnPatternAdvancedLDOptions_struct {
    SearchStrategy searchStrategySupport;    //Specifies the aggressiveness of the rotation search strategy available during the matching phase.
    int            initialStepSize;          //The largest number of image pixels to shift the sample across the inspection image during the initial phase of matching.
    int            initialSampleSize;        //Specifies the number of template pixels that you want to include in a sample for the initial phase of rotation-invariant matching.
    double         initialSampleSizeFactor;  //Specifies the size of the sample for the initial phase of rotation-invariant matching as a percent of the template size, in pixels.
    ...
    int            subpixelSampleSize;       //Specifies the number of template pixels that you want to include in a sample for the subpixel phase of rotation-invariant matching.
    double         subpixelSampleSizeFactor; //Specifies the size of the sample for the subpixel phase of rotation-invariant matching as a percent of the template size, in pixels.
} LearnPatternAdvancedLDOptions;

typedef struct LearnPatternAdvancedPyramidOptions_struct {
    int            subpixelSampleSize;       //Specifies the number of template pixels that you want to include in a sample for the subpixel phase of rotation-invariant matching.
    double         subpixelSampleSizeFactor; //Specifies the size of the sample for the subpixel phase of rotation-invariant matching as a percent of the template size, in pixels.
} LearnPatternAdvancedPyramidOptions;
...
typedef struct MatchPatternAdvancedOptionsLD_struct {
    int            subpixelIterations;          //Defines the maximum number of incremental improvements used to refine matching using subpixel information.
    double         subpixelTolerance;           //Defines the maximum amount of change, in pixels, between consecutive incremental improvements in the match position that you want to trigger the end of the refinement process.
    int            initialMatchListLength;      //Specifies the maximum size of the match list.
    int            matchListReductionFactor;    //Specifies the reduction of the match list as matches are refined.
    ...
    SearchStrategy searchStrategy;              //Specifies the aggressiveness of the rotation search strategy.
    int            intermediateAngularAccuracy; //Specifies the accuracy to use during the intermediate phase of rotation-invariant matching.
} MatchPatternAdvancedOptionsLD;

typedef struct MatchPatternAdvancedOptionsPyramid_struct {
	int			   maxPyramidLevel;
	int			   enableSpiralSearch;
	int			   enableSubpixelSearch;
    int            subpixelIterations;          //Defines the maximum number of incremental improvements used to refine matching using subpixel information.
    double         subpixelTolerance;           //Defines the maximum amount of change, in pixels, between consecutive incremental improvements in the match position that you want to trigger the end of the refinement process.
    int            initialMatchListLength;      //Specifies the maximum size of the match list.
    int            matchListReductionFactor;    //Specifies the reduction of the match list as matches are refined.
    int            initialAngularAccuracy;      //Specifies the number of pixels to shift the sample across the inspection image during the initial phase of shift-invariant matching.
	int			   processBorderMatches;
	int			   fastMatchMode;
} MatchPatternAdvancedOptionsPyramid;
...
typedef struct BarcodeGradingReport_struct {
    char overallGrade;
    char edgeDeterminationGrade;
    char minimumReflectanceGrade;
    char minimumContrastGrade;
    char symbolContrastGrade;
    char modulationGrade;
    char defectsGrade;
    char decodeGrade;
    char decodabilityGrade;
    char quietZone;
} BarcodeGradingReport;

typedef struct BarcodeGradingOptions_struct {
    int calcGradingReport;
    unsigned int scanProfileWidth;
} BarcodeGradingOptions;
...
typedef struct BarcodeInfoReport_struct {
   BarcodeInfo2* info;
   unsigned int numBarcodes;
} BarcodeInfoReport;

typedef struct BarcodeInfoReportandGrading_struct {
   BarcodeInfo2* info;
   unsigned int numBarcodes;
   BarcodeGradingReport* gradingReport;
} BarcodeInfoReportandGrading;
...
typedef struct DetectorReport_struct{
    PointFloat* featureCoordinates;     // It returns the coordinates of the detected feature points
    unsigned int  numfeatures;                    // It returns the number of detected feature points
    double* featureScores;                        // It returns the scores of the detected feature points
    PointFloat* featureCoordinatesReal; // It returns the coordinates of the detected feature points in real world
    unsigned int* calibrationValid;               // It returns a valid boolean for each real world coordinate
}DetectorReport;

typedef struct FeatureDescriptor_struct{
    unsigned char* desc;       // It is the descriptor for a particular detected feature point
    unsigned int size;         // It is the size of the descriptor for the detected feature point
}FeatureDescriptor;

typedef struct DescriptorReport_struct{
    PointFloat* featureCoordinates;    // It returns the coordinates of the detected feature points
    unsigned int  numfeatures;                   // It returns the number of detected feature points
    FeatureDescriptor* descriptor;               // It returns the descriptor for each detected feature point
}DescriptorReport;

typedef struct FeatureVectorReport{
    float* features;                          // It returns the coordinates of the extraced features
    unsigned int  numfeatures;                    // It returns the number of extracted features
}ExtractorReport;
...
typedef struct FeatureMatchingReport_struct{
    MatchedPoint* matches;         // It returns the coordinates of the matched feature points between two images
    unsigned int  numMatches;      // It reurns the number of matches found between two images
    double* matchScores;           // It returns the scores of the matches found between two images
    double* homographyMatrix;      // It returns the homography matrix between two images
}FeatureMatchingReport;
...
typedef struct MatchPatternOptions2_struct {
    MatchingAlgorithm   algorithm;           //Specifies the algorithm to use when looking for the pattern in the image.
    RotationAngleRange* angleRanges;         //An array of angle ranges, in degrees, where each range specifies how much you expect the pattern to be rotated in the image.
    int                 numRanges;           //Number of angle ranges in the angleRanges array.
    int                 numMatchesRequested; //Number of valid matches expected.
    int                 matchFactor;         //Controls the number of potential matches that the function examines.
    float               minMatchScore;       //The minimum score a match can have for the function to consider the match valid.
} MatchPatternOptions2;
...
typedef union PixelValue_union {
    ...
    int64       unUsedPixel;     //Unused long long integer pixel value.
	int         color32;         //32 bit representation of the pixel value.
} PixelValue;
...
typedef struct PatternMatchReport_struct {
    PointFloat position;			    //The location of the match.
	PointFloat calibratedPosition;	//The location of the match in real-world units.
	float      rotation;			    //The rotation of the match relative to the template image, in degrees.
    float      calibratedRotation;  //The rotation of the match relative to the template image, in degrees, in real-world units.
    float      scale;				//The size of the match relative to the size of the template image, expressed as a percentage.
    float      calibratedScale;     //The size of the match relative to the size of the template image, expressed as a percentage, in real-world units.
    float      score;				//The accuracy of the match.
    float      calibratedScore;     //The accuracy of the match.
    PointFloat corner[4];			//An array of four points describing the rectangle surrounding the template image.
    PointFloat calibratedCorner[4];	//An array of four points describing the rectangle surrounding the template image in real-world units.
} PatternMatchReport;

typedef struct PatternMatchingLearnAdvancedSetupDataOption_struct	{
	LearnSetupOption learnSetupOption;
    double value;
} PMLearnAdvancedSetupDataOption ;

typedef struct PatternMatchingMatchAdvancedSetupDataOption_struct	{
	MatchSetupOption matchSetupOption ;
	double value ;
} PMMatchAdvancedSetupDataOption ;

typedef struct PresetOption_struct {
    PatternMatchPresetType type;           //The type and value together specify the Preset Option. Please refer to Function&Control help of imaqSetPresetMatchOptions for more details.
    double value;                          //The type and value together specify the Preset Option. Please refer to Function&Control help of imaqSetPresetMatchOptions for more details.
} PresetOption;
...
typedef struct QuantifyData2_struct {
    float        mean;             //The mean value of the pixel values.
    float        stdDev;           //The standard deviation of the pixel values.
    float        min;              //The smallest pixel value.
    float        max;              //The largest pixel value.
    ...
    int          pixelArea;        //The area, in number of pixels.
    float        relativeSize;     //The proportion, expressed as a percentage, of the associated region relative to the whole image.
    unsigned int calibrationValid; //Indicates the calibration information.
} QuantifyData2;
...
typedef struct QuantifyReport2_struct {
    QuantifyData2  global;      //Statistical data of the whole image.
    QuantifyData2* regions;     //An array of QuantifyData structures containing statistical data of each region of the image.
    unsigned int   regionCount; //The number of regions.
} QuantifyReport2;
...
typedef struct ShapeReport2_struct {
    Rect        coordinates; //The bounding rectangle of the object.
    PointFloat  centroid;    //The coordinate location of the centroid of the object.
    int         size;        //The size, in pixels, of the object.
    double      score;       //A value ranging between 1 and 1,000 that specifies how similar the object in the image is to the template.
} ShapeReport2;
...
typedef struct PyramidInfo_struct
{
	int maxPyramidLevel;
    int optimalPyramidLevel;
    int maxPyramidLevelToStoreData;
} PyramidInfoStruct ;

typedef struct MatchOffsetInfo_struct
{
	double matchOffsetX;
	double matchOffsetY;
	double angleOffset;
} MatchOffsetInfoStruct ;

typedef struct PatternMatchTemplateInformation_struct {
    PMMatchAdvancedSetupDataOption* advancedOptionsPointer; //An array of advanced parameters stored inside the template.
    int numAdvancedOptions;                                 //The number of advanced parameters in the advancedOptionsPointer array.
    PresetOption* presetOptionsPointer;                     //An array of preset options stored inside the template.
    int numPresetOptions;                                   //The number of preset options in the presetOptionsPointer array.
    PyramidInfoStruct pyramidInfo;
    MatchOffsetInfoStruct matchOffsetInfo;
} PatternMatchTemplateInformation;

typedef struct GeometricMatchTemplateInformation_struct {
    GeometricAdvancedSetupDataOption* GPMadvancedOptionsPointer; //An array of advanced parameters stored inside the template.
    int numAdvancedOptions;                                      //The number of advanced parameters in the GPMadvancedOptionsPointer array.
    PresetOption* presetOptionsPointer;                          //An array of preset options stored inside the template.
    int numPresetOptions;                                        //The number of preset options in the presetOptionsPointer array.
    CurveParameters _curveParameters;
    MatchOffsetInfoStruct matchOffsetInfo;
} GeometricMatchTemplateInformation;
...
typedef struct TemplateReport_struct {
	int templateContrast;
    int grayvalueMaxPyramidLevel;
    int grayvalueOptimalPyramidLevel;
    int gradientMaxPyramidLevel;
    int gradientOptimalPyramidLevel;
} TemplateReport;

typedef struct ExtractTetragonOptions_struct {
    InterpolationMethod interpolationMethod; // Interpolation Method
    unsigned int        destinationWidth;    // Width
    unsigned int        destinationHeight;   // Height
    float               fillValue;           // Pixel Value
} ExtractTetragonOptions;

typedef struct SSIMComponents_struct {
    double luminance;             // Luminance
    double contrastAndStructural; // Contrast and Structural similarity
} SSIMComponents;

typedef struct BlockSize_struct {
    int xRes; //X resolution of the block.
    int yRes; //Y resolution of the block.
} BlockSize;
typedef struct RectSize_struct {
    int windowWidth;     //size of the window in the x dimension
    int windowHeight;    //size of the window in the y dimension
}RectSize;

typedef struct BlockStatistics_struct {
    double mean;         //The mean pixel value of the block.
    double stdDeviation; //The distribution of pixel values relative to the Mean Value.
    double minValue;     //The smallest pixel value.
    double maxValue;     //The largest pixel value.
} BlockStatistics;
typedef struct LKPyramidOptions_struct
{
    int level;          //specifies the number of pyramid levels to use
    int maxIteration;   //specifies the number of iterations to run the tracking algorithm at each level
    int windowSize;     //specifies the region around each input feature point that is used to search for a match
    double threshold;   //specifies the minimum allowed displacement between the location of the tracked features from iteration to iteration
} LKPyramidOptions;

typedef struct BlockStatisticsReport_struct {
    BlockStatistics* blockStatistics;   //The Blockstatistics report.
    unsigned int     totalNumOfBlocks;  //Total number of blocks.
    int              numofBlocksinXdir; //Number of blocks in X direction.
    int              numofBlocksinYdir; //Number of blocks in Y direction.
} BlockStatisticsReport;
typedef struct FeaturePoints_struct {
    PointFloat*  points;       // The coordinate location of all edges detected by the search line.
    unsigned int numPoints;    // The number of points in the edges array.
} FeaturePoints;

typedef struct RectDouble_struct {
    double Left;   //Location of the left edge of the rectangle.
    double Top;    //Location of the top edge of the rectangle.
    double Right;  //Location of the right edge of the rectangle.
    double Bottom; //Location of the bottom edge of the rectangle.
} RectDouble;
typedef struct DifferenceArray_struct {
    double* difference;       // The coordinate location of all edges detected by the search line.
    unsigned int  arraySize;    // The number of points in the edges array.
} DifferenceArray;

typedef struct StoppingCriteria_struct {
	StoppingType type;      //specifies the type of stopping criteria to use
	int maxIterations;      //specifies that the computation should stop after the number of iterations
	double epsilon;         //specifies the maximum difference allowed between the velocity information computed between two successive iterations
}StoppingCriteria;

typedef struct HighLevelParticleReport_struct {
    double      area;        //The area of the particle
    double      holeCount;   //The number of holes in the particle
    RectDouble  includeRect; //The smallest rectangle with sides parallel to the x-axis and y-axis that completely encloses the particle
    PointDouble centerMass;  //The point representing the average position of the total mass of the particle assuming every point in the particle has a constant density
    double      orientation; //The angle of the line passing through the particle center of mass with the lowest moment of inertia
    PointDouble dimensions;  //The width and height of Bounding Rect.
} HighLevelParticleReport;

typedef struct HighLevelParticleAnalysisReport_struct {
    int                      numberOfParticles;   //The number of particles in the image.
    HighLevelParticleReport* pixelReport;         //The measurement report for each particle, in pixel units.
    HighLevelParticleReport* calibratedReport;    //The measurement report for each particle, in calibrated units.
    short*                   calibrationValidity; //The validity of each calibrated particle measurement report.
} HighLevelParticleAnalysisReport;

typedef struct FlatFieldCorrectionOptions_struct{
    float correctionFactor;     // Correction Factor is used to bias the mean computed from flat field image. It ranges from 1 to 1.5
    int lineScanImage;          // Set to TRUE if source image is line scan image
    int optimizeCorrection;     // Set to TRUE enables pre computation of flat field table. Table computation consumes more memory to speed up correction of subsequent images.
}FlatFieldCorrectionOptions;

typedef struct SurfaceFitOptions_struct{
    unsigned int gridWidth;   // Grid width for sampling points to fit surface fit(polynomial) model
    unsigned int gridHeight; // Grid height for sampling points to fit surface fit(polynomial) model
    unsigned int polyDegree; // Polynomial degree for 2D polynomial
}SurfaceFitOptions;

typedef  struct BackgroundEstimation_struct{
    unsigned int IsBackgroundEstimation;    // Set to TRUE to enable background estimation
    BGEstimateMethod  method;               // Method for Background Estimation
    unsigned int polyDegree;                // Polynomial degree for 2D Polynomial surface fit
    unsigned int windowWidth;               // Window width for Background correction thresholding method
    unsigned int windowHeight;              // Window height for Background correction thresholding method
    double devWeight;                       // Deviation factor for NiBlack thresholding method
}BackgroundEstimation;

typedef struct SVMKernelOptions_struct {
    KernelType kernelType;  //The kernel that the classifier uses to determine if a sample is a texture or contains a defect.
    int        degree;      //The degree of the polynomial kernel.
    double     gamma;       //The gamma value for the polynomial and RBF kernels.
    double     coefficient; //The coefficient of the polynomial kernel.
    double     sigma;       //The sigma value for the Gaussian kernel.
    double     cacheSize;   //The cache size, in megabytes.
} SVMKernelOptions;

typedef struct LabelWeight_struct {
    char*  label;  //The label associated with the Weight coefficient.
    double weight; //The weighted coefficient for the Label.
} LabelWeight;

typedef struct SVMModelOptions_struct {
    SVMType      svmType;      //The SVM model that will be used to train the classifier.
    double       epsilon;      //The maximum gradient of the quadratic function used to compute support vectors.
    int          maxIteration; //Maximum number of iterations.
    double       nu;           //The value of Nu. Values range from 0.1 to 1.
    int          shrinking;    //If enabled, the classifier uses shrinking heuristics to attempt to reduce the number of variables involved in the classification computation.
    double       cost;         //The penalty for training errors.
    LabelWeight* labelWeight;  //The cost weight for each label.
    int          labelWeightCount;
} SVMModelOptions;

typedef struct SVMTrainingResults_struct {
    char* label;        //Class into which the classifier session categorizes the input sample.
    float stdDeviation; //The standard deviation from the mean of all samples in Class.
    int   count;        //The number of samples in Class.
    int   svCount;      //The number of support vectors in Class.
} SVMTrainingResults;

typedef struct ClassDistanceTable_struct {
    float* tableData;    //A table giving the mean distance from each class to each other class.
    int    numOfRows;    //Number of rows in the Class Distance Table.
    int    numOfColumns; //Number of columns in the Class Distance Table.
} ClassDistanceTable;

typedef struct SVMReport_struct {
    SVMTrainingResults*    trainingResults;       //An array of statistical information for each class in the classifier.
    unsigned int           SizeOftrainingResults; //Size of TrainingResults array.
    ClassDistanceTable*    classDistanceTable;    //A table giving the mean distance from each class to each other class.
} SVMReport;

typedef struct LearnContourSetupData_struct {
    char*        setupData;        //String that contains information about the setup parameters selected for the learning phase.
    unsigned int setupDataLength;  //setupData legth.
} LearnContourSetupData;

typedef struct PixelData_struct {
    void*        pixelPtr;     //Pointer to pixel data of a single Row/Column.
    unsigned int numOfPixels;  //Number of pixels.
} PixelData;

typedef struct Palette_struct {
    RGBValue*    paletteData;        //An array of clusters for each of the three color planes (red, green, and blue).
    unsigned int paletteDataLength;  //Palette Data legth.
} Palette;

typedef struct ObjectDescription_struct{
	char*        label;            //Label of the object in the tracking session.
	int          score;            //Score of the object being tracked.
	double       angle;            //The starting angle of the object to track, This parameter only applies when using the Shape Adapted Mean Shift algorithm.
	PointDouble  location;         //The x- and y-coordinates of the object being tracked.
	PointDouble* boundingBox;      //An array that defines the boundary of the object being tracked in the image.
    unsigned int boundingBoxSize;  //Number of Elements in the bounding box.
	int          objectFound;      //Indicating whether the object was found in the image. Non-zero when the object was found.
} ObjectDescription;

typedef struct ObjectTrackingReport_struct{
	unsigned int       numOfObjects;          //Number of Objects.
	ObjectDescription* pixelDescription;      //objects found in the image, in pixel coordinates.
	ObjectDescription* realObjectDescription; //objects found in the image, in real-world units.
} ObjectTrackingReport;

typedef struct StereoCalibrationInfoReport_struct {
    double*      RotationMatrix;     //Specifies the rotation transformation between the left and right cameras
    unsigned int RotMRows;           //Number of rows in rotation matrix
    unsigned int RotMCols;           //Number of columns in rotation matrix
    double*      TranslationVector;  //Vector specifying the translation between the left and right cameras
    unsigned int NoTranslEle;        //Number of elements in translation vector
    double*      EssentialMatrix;    //Tranforms a point in the left camera coordinate system to the right camera coordinate system
    unsigned int EsnMRows;           //Number of rows in essential matrix
    unsigned int EsnMCols;           //Number of columns in essential matrix
    double*      FundamentalMatrix;  //Matrix contains the same information as the Essential Matrix and intrinsic information of both cameras.
    unsigned int FndMRows;           //Number of rows in fundamental matrix
    unsigned int FndMCols;           //Number of columns in fundamental matrix
    double*      QMatrix;            //Can be used to convert pixel coordinates along with the disparity value into real-world 3-D points
    unsigned int QMRows;             //Number of rows in QMatrix
    unsigned int QMCols;             //Number of columns in QMatrix
} StereoCalibrationInfoReport;

typedef struct Pixelto3dCoordinatesReport_struct{
    StereoPointDbl3D  RealCoordPt;           //Real-world point coordinates that correspond to the points specified by Pixel Coordinates
    StereoPointDbl3D* Real3DPoints;          //An array of real-world point coordinates corresponding to the array of pixel coordinates
    unsigned int      NumberofReal3DPoints;  //Number of sReal3DPoints elements
    int               Real3DPtValidity;      //Returns TRUE if the output Real World 3D Coordinates has been computed with a valid disparity value
    int*              Real3DPointsValidity;  //An array specifying whether each transformation of the Array of Pixel Coordinates is valid
    unsigned int      NumberofReal3DPtsVldt; //Number of iReal3DPointsValidity elements
}Pixelto3dCoordinatesReport;

typedef struct ImageToStringConversionReport_struct{
    char*        data;       //String Data
    unsigned int dataLength; //String Data length.
} ImageToStringConversionReport;

typedef struct SetOverlayColorInfo_struct{
    char*    groupName;                   //Group name of the overlay whose color is to be set
    RGBValue color;                       //Color which will be applied to overlays
    RGBValue backgroundColor;             //Background color which will be applied to overlays, applicable only for text overlays
} OverlayGroupColor;
...
//============================================================================
IMAQ_FUNC int        IMAQ_STDCALL imaqCast2(Image* dest, const Image* source, ImageType type, CastingMethod method, const float* lookupTable, int numberOfShift);
...
IMAQ_FUNC int        IMAQ_STDCALL imaqExtractTetragon(const Image* src, Image* dest, const ROI* roi, PointFloat* tetragon, ExtractTetragonOptions* options);
...
IMAQ_FUNC PixelData* IMAQ_STDCALL imaqGetRowCol(Image* image,  int index, int isColumnIndex);
...
IMAQ_FUNC int        IMAQ_STDCALL imaqRotate3(Image* dest, const Image* source, double angle, PixelValue fill, InterpolationMethod method, int maintainSize);
IMAQ_FUNC int        IMAQ_STDCALL imaqScale(Image* dest, const Image* source, int xScale, int yScale, ScalingMode scaleMode, Rect rect);
IMAQ_FUNC int        IMAQ_STDCALL imaqSetRowCol(Image* image,  int index, int isColumnIndex, PixelData* pixelData);
...
#if !(defined(_WIN32) || defined(_WIN64))
IMAQ_FUNC int   IMAQ_STDCALL imaqRTDisplayImage(const Image* image, Palette* _palette, int resize);
IMAQ_FUNC int   IMAQ_STDCALL imaqRTVideoMode(RTVideoModeOperation set, RTDisplayVideoMode *graphicsModeFlag);
#endif
...
IMAQ_FUNC ConcentricRakeReport2* IMAQ_STDCALL imaqConcentricRake3(Image* image, ROI* roi, ConcentricRakeDirection direction, EdgeProcess process, int optimizedMode, int stepSize, EdgeOptions2* edgeOptions);
...
IMAQ_FUNC FindEdgeReport*        IMAQ_STDCALL imaqFindEdge3(Image* image, const ROI* roi, const CoordinateSystem* baseSystem, const CoordinateSystem* newSystem, const FindEdgeOptions2* findEdgeOptions, const StraightEdgeOptions* straightEdgeOptions);
...
IMAQ_FUNC RakeReport2*           IMAQ_STDCALL imaqRake3(Image* image, ROI* roi, RakeDirection direction, EdgeProcess process, int optimizedMode, int stepSize, EdgeOptions2* edgeOptions);
...
IMAQ_FUNC SpokeReport2*          IMAQ_STDCALL imaqSpoke3(Image* image, ROI* roi, SpokeDirection direction, EdgeProcess process, int optimizedMode, int stepSize, EdgeOptions2* edgeOptions);
...
IMAQ_FUNC StraightEdgeReport2*   IMAQ_STDCALL imaqStraightEdge3(const Image* image, const ROI* roi, SearchDirection searchDirection, const EdgeOptions2* edgeOptions, const StraightEdgeOptions* straightEdgeOptions, unsigned int optimizedMode);
...
IMAQ_FUNC int         IMAQ_STDCALL imaqReadFile2(Image* image, const char* fileName, int imageTypeSrc, RGBValue* colorTable, int* numColors);
IMAQ_FUNC int         IMAQ_STDCALL imaqReadVisionFile2(Image* image, const char* fileName, int imageTypeSrc, RGBValue* colorTable, int* numColors);
...
//  AVI2 I/O functions
//============================================================================
IMAQ_FUNC FilterName* IMAQ_STDCALL imaqGetFilterNames2(Image* image, CodecSourceType codecType, int *numFilters);
IMAQ_FUNC AVI2Session IMAQ_STDCALL imaqCreateAVI2(const char *filename, const char *compressionFilter, int quality, unsigned int framesPerSecond);
IMAQ_FUNC int         IMAQ_STDCALL imaqWriteAVIFrame2(Image *image, AVI2Session avi2Session);
IMAQ_FUNC AVI2Session IMAQ_STDCALL imaqOpenAVI2(const char *fileName, CodecSourceType codecType);
IMAQ_FUNC int         IMAQ_STDCALL imaqReadAVIFrame2(Image* image, AVI2Session avi2Session, int frameNumber);
IMAQ_FUNC int         IMAQ_STDCALL imaqGetAVIInfo2(AVI2Session avi2Session, AVIInfo *aviInfo);
IMAQ_FUNC int         IMAQ_STDCALL imaqCloseAVI2(AVI2Session avi2Session);
...
IMAQ_FUNC int    IMAQ_STDCALL imaqImageToImage(Image* largeImage, const Image* smallImage, Image* dest, const Rect* offset, const Image* mask, int keepOverlays);
...
IMAQ_FUNC ColorHistogramReport*              IMAQ_STDCALL imaqColorHistogram3(Image* image, int numClasses, ColorMode mode, const CIEXYZValue* whiteReference, const RangeFloat* range1, const RangeFloat* range2, const RangeFloat* range3, Image* mask);
...
IMAQ_FUNC int                                IMAQ_STDCALL imaqMipiCsi2ByteStreamToImage(Image* image, MipiCsi2Format format, const unsigned char* byteStream, size_t bytesToCopy);
...
IMAQ_FUNC Palette* IMAQ_STDCALL imaqGetPalette(PaletteType paletteType);
...
IMAQ_FUNC int    IMAQ_STDCALL imaqCopyVisionInfo(Image* source, Image* dest, unsigned int* infoFlags);
...
IMAQ_FUNC int IMAQ_STDCALL imaqOverlayLines3(Image* image, const PointDouble* points, int numPoints, DrawMode drawMode, const RGBValue* color, const char* group, unsigned int useDcWidth, unsigned int width);
...
IMAQ_FUNC int IMAQ_STDCALL imaqSetOverlayColor(Image* image, OverlayGroupColor* groupColors, int numEntries);
IMAQ_FUNC int IMAQ_STDCALL imaqSetOverlayProperties(Image* image, const char* group, TransformBehaviors* transformBehaviors);
IMAQ_FUNC int IMAQ_STDCALL imaqOverlayMotionVectors(Image* srcImage, const Image *velX, const Image* velY, int velocityRep,  double threshold, double scale, int stepSize, RGBValue* color,  const char* groupName);
//============================================================================
//  Meter functions
//============================================================================
...
IMAQ_FUNC BarcodeInfoReport* IMAQ_STDCALL imaqReadBarcode2(const Image* image, const Barcode1DSearchOptions* searchOptions,BarcodeType* barcodeTypes, unsigned int numOfTypes, unsigned int numRequiredBarcodes, const ROI* roi, int validate);
IMAQ_FUNC BarcodeInfoReportandGrading* IMAQ_STDCALL imaqReadBarcode3(const Image* image, const Barcode1DSearchOptions* searchOptions, BarcodeType* barcodeTypes, unsigned int numOfTypes, unsigned int numRequiredBarcodes, const ROI* roi, int validate, const BarcodeGradingOptions* gradingOptions);
...
IMAQ_FUNC DataMatrixReport* IMAQ_STDCALL imaqReadDataMatrixBarcode3(Image* image, const ROI* roi, DataMatrixGradingMode prepareForGrading, const DataMatrixDescriptionOptions* descriptionOptions, const DataMatrixSizeOptions* sizeOptions, const DataMatrixSearchOptions* searchOptions, const AdvancedDataMatrixOptions* barcodeAdvancedOptions, unsigned int numAdvancedOptions);
IMAQ_FUNC DataMatrixReport* IMAQ_STDCALL imaqReadDataMatrixBarcode4(Image* image, const ROI* roi, DataMatrixGradingMode prepareForGrading, const DataMatrixDescriptionOptions* descriptionOptions, const DataMatrixSizeOptions* sizeOptions, const DataMatrixSearchOptions* searchOptions, const AdvancedDataMatrixOptions* barcodeAdvancedOptions, unsigned int numAdvancedOptions, float* meanLight);
...
IMAQ_FUNC int               IMAQ_STDCALL imaqGradeDataMatrixBarcodeAIMDPM(const Image* image, CalibReflectanceStruct* calibReflectance, AIMDPMGradeReport* report);
IMAQ_FUNC int               IMAQ_STDCALL imaqGradeDataMatrixBarcodeISO15415(const Image* image, GradeReportISO15415* report);
IMAQ_FUNC int               IMAQ_STDCALL imaqGradeDataMatrixBarcodeISO16022(Image* image, GradeReportISO16022* report);
...
//============================================================================
IMAQ_FUNC ShapeReport2* IMAQ_STDCALL  imaqMatchShape2(Image* dest, Image* source, const Image* templateImage, int scaleInvariant, int connectivity8, double tolerance, int* numMatches);
...
IMAQ_FUNC int                    IMAQ_STDCALL imaqContourLearn(Image* image, LearnContourSetupData* setupData, Image* mask);
IMAQ_FUNC LearnContourSetupData* IMAQ_STDCALL imaqContourSetupLearnPattern(Image* image, GeometricAdvancedSetupDataOption* geometricOptions, unsigned int numGeometricOptions);
...
//============================================================================
IMAQ_FUNC BlockStatisticsReport*           IMAQ_STDCALL imaqBlockStatistics(const Image* image, BlockSize blockSize, int calculateMinMax);
...
IMAQ_FUNC int                              IMAQ_STDCALL imaqFastSSIM(const Image* testImage, const Image* referenceImage, Image* ssimMap, int windowSize, double* meanSSIM, SSIMComponents* ssimComponents);
IMAQ_FUNC HighLevelParticleAnalysisReport* IMAQ_STDCALL imaqHighLevelParticleAnalysis(Image* image, int connectivity48);
...
IMAQ_FUNC int                              IMAQ_STDCALL imaqNormalSSIM(const Image* testImage, const Image* referenceImage, Image* ssimMap, int windowSize, double* meanSSIM, SSIMComponents* ssimComponents);
IMAQ_FUNC QuantifyReport2*                 IMAQ_STDCALL imaqQuantify2(const Image* image, const Image* mask);
...
//  Threshold functions
//============================================================================
IMAQ_FUNC ThresholdData* IMAQ_STDCALL imaqAutoThreshold3(Image* dest, const Image* source, int numClasses, ThresholdMethod method, ObjectType lookForParticleType, float value, RangeFloat* limits, ROI* roi,const Image* mask);
IMAQ_FUNC int            IMAQ_STDCALL imaqLocalThreshold2(Image* dest, const Image* source, unsigned int windowWidth, unsigned int windowHeight, LocalThresholdMethod method, double deviationWeight, double sauvolaDeviationRange, ObjectType type, float replaceValue);
...
IMAQ_FUNC GeometricPatternMatch3*             IMAQ_STDCALL imaqMatchGeometricPattern5(const Image* image, const Image* pattern, const MatchGeometricPatternOptions* matchOptions, GeometricAdvancedSetupDataOption* advancedMatchOptions, unsigned int numadvancedMatchOptions, const ROI* roi, size_t* numMatches);
...
IMAQ_FUNC int                                 IMAQ_STDCALL imaqLearnGeometricPattern3(Image* image, PointFloat originOffset, double angleOffset, const CurveOptions* curveOptions, const LearnGeometricPatternAdvancedOptions2* advancedLearnOptions, const Image* mask, const Image* weightmap);
IMAQ_FUNC int                                 IMAQ_STDCALL imaqSetAdvancedGeometricPatternOptions(Image* image, const GeometricAdvancedSetupDataOption* advancedOptionsHandle, unsigned int numAdvancedOptions);
IMAQ_FUNC GeometricMatchTemplateInformation*  IMAQ_STDCALL imaqGetGeometricPatternTemplateInformation(const Image* templateImage, Image* maskImage, Image* weightMap);
...
IMAQ_FUNC int						          IMAQ_STDCALL imaqLearnPattern6(Image* templateImage, const Image* weightMap, const Image* maskImage, MatchingAlgorithm matchingAlgorithm, RotationAngleRange* rotationAngleRange, const PMLearnAdvancedSetupDataOption* advancedOptionsHandle, unsigned int numAdvancedOptions, TemplateReport* templateReport);
IMAQ_FUNC PatternMatchReport*	              IMAQ_STDCALL imaqMatchPattern4(const Image* image, const Image* pattern, MatchingAlgorithm matchingAlgorithm, int numRequestedMatches, float minScore, RotationAngleRange* rotationAngleRange, int numRotationAngleRange, const ROI* roi, const PMMatchAdvancedSetupDataOption* advancedOptionsHandle, unsigned int numAdvancedOptions, int* numMatchesFound );
IMAQ_FUNC int                                 IMAQ_STDCALL imaqSetAdvancedMatchPatternOptions(Image* image, MatchingAlgorithm algorithm, const PMMatchAdvancedSetupDataOption* advancedOptionsHandle, unsigned int numAdvancedOptions);
IMAQ_FUNC int						          IMAQ_STDCALL imaqGetTemplateInformation(	const Image* templateImage, Image* maskImage, MatchingAlgorithm matchingAlgorithm, PyramidInfoStruct* pyramidInfo , MatchOffsetInfoStruct* matchOffsetInfo);
IMAQ_FUNC int						          IMAQ_STDCALL imaqGetTemplateInformation2(const Image* templateImage, Image* maskImage, Image* weightMap, MatchingAlgorithm matchingAlgorithm, PyramidInfoStruct* pyramidInfo, MatchOffsetInfoStruct* matchOffsetInfo);
IMAQ_FUNC PatternMatchTemplateInformation*    IMAQ_STDCALL imaqGetTemplateInformation3(const Image* templateImage, Image* maskImage, Image* weightMap, MatchingAlgorithm matchingAlgorithm);
IMAQ_FUNC int						          IMAQ_STDCALL imaqCalculateDefectMap(const Image* srcImage, int windowSize, Image** defectImages, unsigned int numOfImages);
IMAQ_FUNC int                                 IMAQ_STDCALL imaqSetPresetMatchOptions(Image* image, PatternMatchPresetFunction function, const PresetOption* presetOptionsHandle, unsigned int numPresetOptions);
...
IMAQ_FUNC CalibrationReferencePoints* IMAQ_STDCALL imaqCalibrationTargetToPoints2(Image* image, Image* mask, const ROI* roi, const GridDescriptor* gridDescriptor, const MaxGridSize* maxGridSize);
...
IMAQ_FUNC int                         IMAQ_STDCALL imaqCalibrationSetAxisInfoByReferencePoints(Image* image, const PointDouble* pixelCoordinates, int numPixelCoordinates, const PointDouble* realCoordinates, int numRealCoordinates);
...
IMAQ_FUNC int                         IMAQ_STDCALL imaqLearnPerspectiveCalibration(Image* templateImage, const Image* image, const CalibrationReferencePoints* referencePoints);
IMAQ_FUNC int                         IMAQ_STDCALL imaqLearnMicroPlaneCalibration(Image* templateImage, const Image* image, const CalibrationReferencePoints* referencePoints);
IMAQ_FUNC InternalParameters*         IMAQ_STDCALL imaqLearnCameraModel(Image* templateImage, const Image* image, const CalibrationReferencePoints* referencePoints, const CalibrationModelSetup* cameraModelSetup, int isAddPointsAndLearn);
IMAQ_FUNC InternalParameters*         IMAQ_STDCALL imaqLearnCameraModel2(Image* templateImage, const Image* image, const CalibrationReferencePoints* referencePoints, const CalibrationModelSetup* cameraModelSetup, int isAddPointsAndLearn);
IMAQ_FUNC int                         IMAQ_STDCALL imaqLearnDistortionModel(Image* templateImage, const Image* image, const CalibrationReferencePoints* referencePoints, const CalibrationModelSetup* distortionModelSetup, int isAddPointsAndLearn);
IMAQ_FUNC int                         IMAQ_STDCALL imaqLearnDistortionModel2(Image* templateImage, const Image* image, CalibrationReferencePoints* referencePoints, const CalibrationModelSetup* distortionModelSetup, int isAddPointsAndLearn);
IMAQ_FUNC int                         IMAQ_STDCALL imaqCalibrationCorrectionLearnSetup2(Image* templateImage, const CalibrationCorrectionLearnSetupInfo* setupInfo, const ROI* roi, int isApplyCalibrationAxis);
...
IMAQ_FUNC int              IMAQ_STDCALL imaqReadOCRFile2(const char* fileName, CharSet* set, String255 setDescription, ReadTextOptions* readOptions, OCRProcessingOptions2* processingOptions, OCRSpacingOptions2* spacingOptions);
IMAQ_FUNC ReadTextReport4* IMAQ_STDCALL imaqReadText4(const Image* image, const CharSet* set, const ROI* roi, int numberOfLinesRequested, const ReadTextOptions* readOptions, const OCRProcessingOptions2* processingOptions, const OCRSpacingOptions2* spacingOptions);
...
IMAQ_FUNC int              IMAQ_STDCALL imaqTrainChars2(const Image* image, CharSet* set, int index, const char* charValue, const ROI* roi, const OCRProcessingOptions2* processingOptions, const OCRSpacingOptions2* spacingOptions);
...
IMAQ_FUNC int              IMAQ_STDCALL imaqWriteOCRFile2(const char* fileName, const CharSet* set, const char* setDescription, const ReadTextOptions* readOptions, const OCRProcessingOptions2* processingOptions, const OCRSpacingOptions2* spacingOptions);

//============================================================================
//  Measure Distances functions
//============================================================================
IMAQ_FUNC ClampMax2Report* IMAQ_STDCALL imaqClampMax3(Image* image, const ROI* roi, const CoordinateSystem* baseSystem, const CoordinateSystem* newSystem, const CurveOptions* curveSettings, const ClampSettings* clampSettings, const ClampOverlaySettings* clampOverlaySettings);
...
IMAQ_FUNC int               IMAQ_STDCALL imaqROIToMask2(Image* mask, const ROI* roi, int fillValue, int backgoundValue, const Image* imageModel, int* isROIinImageModelSpace);
...
//  Morphology functions
//============================================================================
IMAQ_FUNC int IMAQ_STDCALL imaqGrayMorphology2(Image* dest, Image* source, MorphologyMethod method, const StructuringElement* structuringElement, int numberOfIterations);
...
IMAQ_FUNC SVMReport*                     IMAQ_STDCALL imaqClassificationTrainSVM(ClassifierSession* session, SVMModelOptions* modelOptions, const SVMKernelOptions* kernelOptions);
...
//  Stereo functions
//============================================================================
IMAQ_FUNC StereoSession*                IMAQ_STDCALL imaq3DVisionCreateBinocularStereoSession(void);
IMAQ_FUNC int                           IMAQ_STDCALL imaq3DVisionDisposeBincocularStereoSession(StereoSession* cSessionToDelete);
IMAQ_FUNC StereoSession*                IMAQ_STDCALL imaq3DVisionReadBincocularStereoFile(const StereoSession* cSessionToUpdate, const char* chFilePath, String255 stDescription);
IMAQ_FUNC int                           IMAQ_STDCALL imaq3DVisionWriteBincocularStereoFile(const StereoSession* cSessionReference, const char* chFilePath, StereoSessionWriteOptions eOptions, String255 stDescriptionToWrite);
IMAQ_FUNC int                           IMAQ_STDCALL imaqVision3DLearnBincocularStereoCalibration(const Image* imgLeft, const Image* imgRight, const StereoSession* cStereoSession, const StereoLearnCalibQualiy* sStereoLearnCalibQualiy, const StereoRtfSettings* sStereoRtfSettings);
IMAQ_FUNC StereoCalibrationInfoReport*  IMAQ_STDCALL imaqVision3DBincocularGetCalibrationInfo(const StereoSession* cSessionReference, ROI* sRoiLeft, ROI* sRoiRight);
IMAQ_FUNC int                           IMAQ_STDCALL imaqVision3DBinocularStereoCorrespondenceUsingBM2(const Image* imgLeft, const Image* imgRight, const Image* imgDisparityMap, const Image* imgCostMap, const StereoSession* cStereoSession, StereoCameraPosition eCameraLocation, StereoPrefilterOptions* sPrefilterOptions, StereoBlockMatchingOptions* sBlockMatchingOptions, StereoPostfilterOptions* sPostfilterOptions, const int iProcessBandVal);
IMAQ_FUNC int                           IMAQ_STDCALL imaqVision3DBinocularStereoCorrespondenceUsingSGBM2(const Image* imgLeft, const Image* imgRight, const Image* imgDisparityMap, const Image* imgCostMap, const StereoSession* cStereoSession, StereoCameraPosition eCameraLocation, int ePreCapFilter, StereoSGBlockMatchingOptions* sBlockMatchingOptions, StereoPostfilterOptions* sPostfilterOptions, int iProcessBandVal);
IMAQ_FUNC int                           IMAQ_STDCALL imaqVision3DBincocularStereoGetRectifiedImage(const Image* imgSource, const Image* imageDest, const StereoSession* cStereoSession, StereoCameraPosition eCameraLocation, StereoInterpolationType eInterpolationType);
IMAQ_FUNC int                           IMAQ_STDCALL imaqVision3DBincocularStereoGetDepthImage(const Image* imgSource, const Image* imageDest, const Image* imageErrorMap, const StereoSession* cStereoSession, StereoCameraPosition eCameraposition, float fInvalidDisparityValue, StereoDepthControl sStereoDepthControl);
IMAQ_FUNC int                           IMAQ_STDCALL imaqVision3DBincocularStereoGetDepthPlanes(Image* imgSource, const Image* imgXPlane, const Image* imgYPlane, const Image* imgZPlane, const StereoSession* cStereoSession, StereoCameraPosition eCameraposition, float fInvalidDisparityValue, StereoDepthControl sStereoDepthControl);
IMAQ_FUNC Pixelto3dCoordinatesReport*   IMAQ_STDCALL imaqVision3DBincocularConvertPixelTo3DCoordinates(const StereoSession* cStereoSession, Image* imgDisparity, StereoCameraPosition eCameraposition, StereoPointDbl3D* sPtDbl3DOrigin, StereoPointDbl3D* sPtDbl3Rotation, StereoCoordPtFloat* sPixel2dPt, StereoCoordPtFloat* sPixel2dPoints, unsigned int iNumberofPixel2dPoints, float fInvalidDisparityValue, double dMinDepth, double dMaxDepth);
IMAQ_FUNC int                           IMAQ_STDCALL imaqGetMaxDisparityFromMinDepth(double* a2QMarix, const int* iRows, const int* iCols, const double dMinDepth, const int dImageWidth, int* iMaxDisparity, double* dMinDepthCovered);
IMAQ_FUNC int                           IMAQ_STDCALL imaqInterpolateDisparityImage2(Image* imgDisparity, Image* imageDest, const int iSamplingFrequency, const int iOrder, const int iMinDisp, const int iNumDisparities, float fInvalidPixelValue, const int iProcessBandVal);
...
//============================================================================
//  Feature Correspondence functions
//============================================================================
IMAQ_FUNC DetectorReport*   IMAQ_STDCALL imaqFastDetection(const Image* image, const ROI* roi, const unsigned int minFeaturePointStrength, const unsigned int suppressWeakPoints);
...
IMAQ_FUNC DescriptorReport* IMAQ_STDCALL imaqFeatureDescription(const Image* image, PointFloat* featurePoints, unsigned int numFeatures, FeatureDescriptionMethods method);
IMAQ_FUNC FeatureMatchingReport*   IMAQ_STDCALL imaqFeatureMatching(DescriptorReport* report1, DescriptorReport* report2, double maxAcceptableDistance, double errorThreshold);
IMAQ_FUNC ExtractorReport*   IMAQ_STDCALL imaqFeatureExtraction(const Image* image, const ROI* roi, const unsigned int binSize, const unsigned int gridSizeX, const unsigned int gridSizeY, const FeatureExtractionMethods method);
//============================================================================
//  Flat Field Correction Functions
//============================================================================
IMAQ_FUNC int IMAQ_STDCALL imaqFlatFieldCorrection(const Image* image, Image* dest, Image* flatFieldImage, const Image* darkFieldImage, const ROI* roi, const FlatFieldCorrectionOptions* correctionOptions);
IMAQ_FUNC int IMAQ_STDCALL imaqEstimateFlatFieldModel(const Image* image, Image* dest, const Image* maskImage, const ROI* roi, const SurfaceFitOptions* surfaceFitParams, const BackgroundEstimation* bgEstimateParams);
IMAQ_FUNC int IMAQ_STDCALL imaqComputeAverageImage(const Image** images, unsigned int numOfImages, Image* dest);
IMAQ_FUNC int IMAQ_STDCALL imaqComputeMedianImage(const Image** images, unsigned int numOfImages, Image* dest);

//============================================================================
//  Optical Flow
//============================================================================
IMAQ_FUNC int IMAQ_STDCALL imaqOpticalFlowLucasKanade(const Image* currentImage, const Image* previousImage, const ROI* roi, Image* velocityXImage, Image* velocityYImage, const RectSize* sizeWindow, VelocityRepresentation velocityRep);
IMAQ_FUNC int IMAQ_STDCALL imaqOpticalFlowHornSchunck(const Image* currentImage, const Image* previousImage, const ROI *roi, Image* velocityXImage, Image* velocityYImage, int usePrevious, float SmoothingParameter, const StoppingCriteria* stopCriteria, VelocityRepresentation velocityRep);
IMAQ_FUNC int IMAQ_STDCALL imaqOpticalFlowPyramidLucasKanade (const Image *currentImage, const Image *previousImage, LKPyramidOptions * options, const float *kernel,unsigned int kernelSize, DifferenceArray *diffArray, FeaturePoints *featurePointsIn, FeaturePoints*featurePointsOut);

//============================================================================
//  Object Tracking
//============================================================================
IMAQ_FUNC ObjectTrackingSession* IMAQ_STDCALL imaqObjectTrackingCreateSession();
IMAQ_FUNC int                    IMAQ_STDCALL imaqObjectTrackingCloseSession(ObjectTrackingSession* objectTrackingSession);
IMAQ_FUNC int                    IMAQ_STDCALL imaqObjectTrackingGetSessionInfo(ObjectTrackingSession* objectTrackingSession, int* sessionType, int* numInstances);
IMAQ_FUNC int                    IMAQ_STDCALL imaqObjectTrackingWriteSessionInfoToFile(ObjectTrackingSession* objectTrackingSession, const char* filename, const char* description);
IMAQ_FUNC int                    IMAQ_STDCALL imaqObjectTrackingReadSessionInfoFromFile(ObjectTrackingSession* objectTrackingSession, const char* filename, char** description, unsigned int* _descriptionLength, int* sessionType, int* numObjects);
IMAQ_FUNC int                    IMAQ_STDCALL imaqObjectTrackingAddObject(ObjectTrackingSession* objectTrackingSession, const Image* image, const ROI* roi, char*  label);
IMAQ_FUNC int                    IMAQ_STDCALL imaqObjectTrackingDeleteObject(ObjectTrackingSession* objectTrackingSession, const int instanceNumber);
IMAQ_FUNC ObjectTrackingReport*	 IMAQ_STDCALL imaqObjectTrackingTrackObjects(ObjectTrackingSession* objectTrackingSession, const Image* image, const int minScore);
IMAQ_FUNC int                    IMAQ_STDCALL imaqObjectTrackingGetObjectInfo(ObjectTrackingSession* objectTrackingSession, const int index, Image* image, char** instanceLabel, PointDouble* location, double* angle);
IMAQ_FUNC int                    IMAQ_STDCALL imaqObjectTrackingRenameObjectLabel(ObjectTrackingSession* objectTrackingSession, const int index, const char* instanceLabel);
IMAQ_FUNC int                    IMAQ_STDCALL imaqObjectTrackingSetInitialObjectPosition(ObjectTrackingSession* objectTrackingSession, const int index, const double positionX, const double positionY, double initialAngle);
IMAQ_FUNC int                    IMAQ_STDCALL imaqObjectTrackingMeanShiftOptions(ObjectTrackingSession* objectTrackingSession, const int getSetOptions, int *numHistogramBins, double *blendingParameter, int *maximumIterations);
IMAQ_FUNC int                    IMAQ_STDCALL imaqObjectTrackingEMeanShiftOptions(ObjectTrackingSession* objectTrackingSession, const int getSetOptions, int *numHistogramBins, double *blendingParameter, int *maximumIterations, double *maxScaleChange, double *maxRotationChange, double *maxShapeChange);

//============================================================================
//  Image to String Conversion
//============================================================================
IMAQ_FUNC ImageToStringConversionReport* IMAQ_STDCALL imaqWriteBMPString(const Image* image, int compress, const RGBValue* colorTable);
IMAQ_FUNC ImageToStringConversionReport* IMAQ_STDCALL imaqWriteJPEGString(const Image* image, unsigned int quality, const RGBValue* colorTable);
IMAQ_FUNC ImageToStringConversionReport* IMAQ_STDCALL imaqWritePNGString(const Image* image, unsigned int quality, int useBitDepth, const RGBValue* colorTable);
IMAQ_FUNC ImageToStringConversionReport* IMAQ_STDCALL imaqWriteTIFFString(const Image* image, const TIFFFileOptions* options, const RGBValue* colorTable);
IMAQ_FUNC ImageToStringConversionReport* IMAQ_STDCALL imaqWriteImageAndVisionInfoString(const Image* image, const RGBValue* colorTable);
...
IMAQ_FUNC GeometricPatternMatch3*     IMAQ_STDCALL imaqMatchGeometricPattern4(const Image* image, const Image* pattern, const CurveOptions* curveOptions, const MatchGeometricPatternOptions* matchOptions, const MatchGeometricPatternAdvancedOptions4* advancedMatchOptions, const ROI* roi, size_t* numMatches);
...
IMAQ_FUNC int                         IMAQ_STDCALL imaqCalibrationCorrectionLearnSetup(Image* templateImage, const CalibrationCorrectionLearnSetupInfo* setupInfo, const ROI* roi);
...
IMAQ_FUNC CalibrationReferencePoints* IMAQ_STDCALL imaqCalibrationTargetToPoints(Image* image, const ROI* roi, const GridDescriptor* gridDescriptor, const MaxGridSize* maxGridSize);
...
IMAQ_FUNC int                         IMAQ_STDCALL imaqLearnPattern4(Image* templateImage, const Image* maskImage, MatchingAlgorithm matchingAlgorithm, RotationAngleRange* rotationAngleRange, const PMLearnAdvancedSetupDataOption* advancedOptionsHandle, unsigned int numAdvancedOptions, TemplateReport* templateReport);
IMAQ_FUNC int						IMAQ_STDCALL imaqLearnPattern5(Image* templateImage, const Image* weightMap, const Image* maskImage, MatchingAlgorithm matchingAlgorithm, RotationAngleRange* rotationAngleRange, const PMLearnAdvancedSetupDataOption* advancedOptionsHandle, unsigned int numAdvancedOptions, TemplateReport* templateReport);
